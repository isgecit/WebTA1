<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_taD_LCModes.aspx.vb" Inherits="EF_taD_LCModes" title="Edit: Category Wise L C Modes" %>
<asp:Content ID="CPHtaD_LCModes" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabeltaD_LCModes" runat="server" Text="&nbsp;Edit: Category Wise L C Modes"></asp:Label>
</div>
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "taD_LCModesGetByID"
  UpdateMethod="taD_LCModesUpdate"
  DeleteMethod="taD_LCModesDelete"
