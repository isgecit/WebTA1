<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_taD_TravelModes.aspx.vb" Inherits="EF_taD_TravelModes" title="Edit: Category Wise Travel Modes" %>
<asp:Content ID="CPHtaD_TravelModes" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabeltaD_TravelModes" runat="server" Text="&nbsp;Edit: Category Wise Travel Modes"></asp:Label>
</div>
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "taD_TravelModesGetByID"
  UpdateMethod="taD_TravelModesUpdate"
  DeleteMethod="taD_TravelModesDelete"
