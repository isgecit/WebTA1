<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_taD_GuestHouseDA.aspx.vb" Inherits="EF_taD_GuestHouseDA" title="Edit: Category-City Wise DA- Guest House Stay" %>
<asp:Content ID="CPHtaD_GuestHouseDA" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabeltaD_GuestHouseDA" runat="server" Text="&nbsp;Edit: Category-City Wise DA- Guest House Stay"></asp:Label>
</div>
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "taD_GuestHouseDAGetByID"
  UpdateMethod="taD_GuestHouseDAUpdate"
  DeleteMethod="taD_GuestHouseDADelete"
