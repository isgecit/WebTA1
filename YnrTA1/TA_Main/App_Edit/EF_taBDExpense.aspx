<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_taBDExpense.aspx.vb" Inherits="EF_taBDExpense" title="Edit: Other Expenses" %>
<asp:Content ID="CPHtaBDExpense" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabeltaBDExpense" runat="server" Text="&nbsp;Edit: Other Expenses"></asp:Label>
</div>
...
<asp:FormView ID="FVtaBDExpense"
  ...
  <EditItemTemplate>
    ...
    <table style="margin:auto;border: solid 1pt lightgrey">
      ...
      <tr>
        ...
        <td>
          <asp:TextBox
            ...
            onblur= "script_taBDExpense.validate_ProjectID(this);"
            Runat="Server" />
          <asp:Label
          ...
          <AJX:AutoCompleteExtender
            ...
            OnClientItemSelected="script_taBDExpense.ACEProjectID_Selected"
            OnClientPopulating="script_taBDExpense.ACEProjectID_Populating"
            OnClientPopulated="script_taBDExpense.ACEProjectID_Populated"
      ...
      <tr><td colspan="4" style="border-top: solid 1pt LightGrey" ></td></tr>
      <tr id="taBDExpense_0"><td colspan="4" onclick="groupClicked(this);" class="groupHeader" >Accounts Section</td></tr>
      <tr>
        <td class="alignright">
      ...
      <tr><td colspan="4" style="border-top: solid 1pt LightGrey" ></td></tr>
      <tr id="taBDExpense_1"><td colspan="4" onclick="groupClicked(this);" class="groupHeader" >Approval Status</td></tr>
      <tr>
        <td class="alignright">
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "taBDExpenseGetByID"
  UpdateMethod="UZ_taBDExpenseUpdate"
  DeleteMethod="UZ_taBDExpenseDelete"
