Partial Class EF_taCDAccounts
  ...
  Public Property PrimaryKey() As String
    ...
    End Set
  End Property
  Protected Sub ODStaCDAccounts_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles ODStaCDAccounts.Selected
    Dim tmp As SIS.TA.taCDAccounts = CType(e.ReturnValue, SIS.TA.taCDAccounts)
  ...
  Protected Sub FVtaCDAccounts_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles FVtaCDAccounts.PreRender
    TBLtaCDAccounts.EnableSave = Editable
    TBLtaCDAccounts.EnableDelete = Deleteable
    Dim mStr As String = ""
    Dim oTR As IO.StreamReader = New IO.StreamReader(HttpContext.Current.Server.MapPath("~/TA_Main/App_Edit") & "/EF_taCDAccounts.js")
    mStr = oTR.ReadToEnd
    oTR.Close()
    oTR.Dispose()
    ...
    Try
      ...
      Dim tmp2 As Label = CType(FVtaCDAccounts.FindControl("F_CurrencyMain"), Label)
