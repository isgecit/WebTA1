<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_taCDDA.aspx.vb" Inherits="EF_taCDDA" title="Edit: Daily Allowance" %>
<asp:Content ID="CPHtaCDDA" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabeltaCDDA" runat="server" Text="&nbsp;Edit: Daily Allowance"></asp:Label>
</div>
...
<ContentTemplate>
  <LGM:ToolBar0 
    ...
    runat = "server" />
<asp:FormView ID="FVtaCDDA"
  runat = "server"
  DataKeyNames = "TABillNo,SerialNo"
  DataSourceID = "ODStaCDDA"
      ...
      <tr>
        ...
        <td>
          <asp:TextBox
            ...
            Text='<%# Bind("City1ID") %>'
            Enabled = "False"
            ToolTip="Value of Stayed in City."
            CssClass = "dmyfktxt"
            Runat="Server" />
          <asp:Label
...
<%--      <tr>
      ...
      <tr>
        <td class="alignright">
          <asp:Label ID="L_AmountInINR" runat="server" Text="NET DA [INR] :" />&nbsp;
        </td>
        <td colspan="3">
      ...
      <tr><td colspan="4" style="border-top: solid 1pt LightGrey" ></td></tr>
      <tr id="taCDDA_0"><td colspan="4" onclick="groupClicked(this);" class="groupHeader" >Accounts Section</td></tr>
      <tr>
        <td class="alignright">
      ...
      <tr>
        ...
        <td>
          <asp:TextBox
            ...
            onblur= "script_taCDDA.validate_ProjectID(this);"
            Runat="Server" />
          <asp:Label
          ...
          <AJX:AutoCompleteExtender
            ...
            OnClientItemSelected="script_taCDDA.ACEProjectID_Selected"
            OnClientPopulating="script_taCDDA.ACEProjectID_Populating"
            OnClientPopulated="script_taCDDA.ACEProjectID_Populated"
      ...
      <tr>
        ...
        <td class="alignright">
          <asp:Label ID="L_PassedAmountRate" runat="server" Text="Passed DA Per Day :" />&nbsp;
        </td>
        <td>
...
<%--      <tr>
      ...
      <tr>
        <td class="alignright">
          <asp:Label ID="L_PassedAmountInINR" runat="server" Text="NET Passed DA [INR] :" />&nbsp;
        </td>
        <td colspan="3">
...
<%--        <td class="alignright">
      ...
      <tr><td colspan="4" style="border-top: solid 1pt LightGrey" ></td></tr>
      <tr id="taCDDA_1"><td colspan="4" onclick="groupClicked(this);" class="groupHeader" >Approval Status</td></tr>
      <tr>
        <td class="alignright">
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "taCDDAGetByID"
  UpdateMethod="UZ_taCDDAUpdate"
  DeleteMethod="taCDDADelete"
