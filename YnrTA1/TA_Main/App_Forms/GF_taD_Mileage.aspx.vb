Partial Class GF_taD_Mileage
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/TA_Main/App_Display/DF_taD_Mileage.aspx"
  ...
  End Sub
  Protected Sub GVtaD_Mileage_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GVtaD_Mileage.RowCommand
    If e.CommandName.ToLower = "lgedit".ToLower Then
      Try
        Dim SerialNo As Int32 = GVtaD_Mileage.DataKeys(e.CommandArgument).Values("SerialNo")  
        Dim RedirectUrl As String = TBLtaD_Mileage.EditUrl & "?SerialNo=" & SerialNo
        Response.Redirect(RedirectUrl)
      Catch ex As Exception
      End Try
    End If
  End Sub
  Protected Sub GVtaD_Mileage_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVtaD_Mileage.Init
    DataClassName = "GtaD_Mileage"
    SetGridView = GVtaD_Mileage
  End Sub
  ...
  Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    Dim validateScriptCityID As String = "<script type=""text/javascript"">" & _
      ...
      "    validated_FK_TA_D_Mileage_CityID_main = true;" & _
      "    validate_FK_TA_D_Mileage_CityID(o);" & _
      "  }" & _
      "</script>"
    ...
    End If
    Dim validateScriptFK_TA_D_Mileage_CityID As String = "<script type=""text/javascript"">" & _
      "  function validate_FK_TA_D_Mileage_CityID(o) {" & _
      "    var value = o.id;" & _
      "    var CityID = $get('" & F_CityID.ClientID & "');" & _
      "    try{" & _
      "    if(CityID.value==''){" & _
      "      if(validated_FK_TA_D_Mileage_CityID.main){" & _
      ...
      "    PageMethods.validate_FK_TA_D_Mileage_CityID(value, validated_FK_TA_D_Mileage_CityID);" & _
      "  }" & _
      "  validated_FK_TA_D_Mileage_CityID_main = false;" & _
      "  function validated_FK_TA_D_Mileage_CityID(result) {" & _
      ...
      "  }" & _
      "</script>"
    If Not Page.ClientScript.IsClientScriptBlockRegistered("validateFK_TA_D_Mileage_CityID") Then
      Page.ClientScript.RegisterClientScriptBlock(GetType(System.String), "validateFK_TA_D_Mileage_CityID", validateScriptFK_TA_D_Mileage_CityID)
    End If
  End Sub
  <System.Web.Services.WebMethod()> _
