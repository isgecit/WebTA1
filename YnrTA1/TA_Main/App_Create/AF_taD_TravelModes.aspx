<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AF_taD_TravelModes.aspx.vb" Inherits="AF_taD_TravelModes" title="Add: Category Wise Travel Modes" %>
<asp:Content ID="CPHtaD_TravelModes" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabeltaD_TravelModes" runat="server" Text="&nbsp;Add: Category Wise Travel Modes"></asp:Label>
</div>
...
<asp:UpdatePanel ID="UPNLtaD_TravelModes" runat="server" >
  ...
  <LGM:ToolBar0 
    ...
    runat = "server" />
<asp:FormView ID="FVtaD_TravelModes"
  runat = "server"
  DataKeyNames = "SerialNo"
  DataSourceID = "ODStaD_TravelModes"
  DefaultMode = "Insert" CssClass="sis_formview">
  <InsertItemTemplate>
    <div id="frmdiv" class="ui-widget-content minipage">
    <asp:Label ID="L_ErrMsgtaD_TravelModes" runat="server" ForeColor="Red" Font-Bold="true" Text=""></asp:Label>
    <table style="margin:auto;border: solid 1pt lightgrey">
      <tr><td colspan="4" class="groupHeader" >Domestic Travel Modes</td></tr>
      <tr>
        <td class="alignright">
      ...
      <tr>
        <td class="alignright">
          <asp:Label ID="L_EntitlementText" runat="server" Text="Entitlement Text :" />&nbsp;
        </td>
        <td colspan="3">
...
<asp:ObjectDataSource 
  ...
  InsertMethod="taD_TravelModesInsert"
