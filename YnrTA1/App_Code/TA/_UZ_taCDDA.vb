...
Namespace SIS.TA
  Partial Public Class taCDDA
    Public Shadows ReadOnly Property Editable() As Boolean
      ...
      End Get
    End Property
    Public Shared Function UZ_taCDDASelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal TABillNo As Int32) As List(Of SIS.TA.taCDDA)
      Dim Results As List(Of SIS.TA.taCDDA) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          If SearchState Then
            Cmd.CommandText = "spta_LG_CDDASelectListSearch"
            Cmd.CommandText = "sptaCDDASelectListSearch"
            SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@KeyWord", SqlDbType.NVarChar, 250, SearchText)
          Else
            Cmd.CommandText = "spta_LG_CDDASelectListFilteres"
      ...
      Return Results
    End Function
    Public Shared Function UZ_taCDDAUpdate(ByVal Record As SIS.TA.taCDDA) As SIS.TA.taCDDA
      ...
      End With
      _Rec = SIS.TA.taCDDA.UpdateData(_Rec)
