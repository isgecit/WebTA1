  ...
  Partial Public Class taD_Lodging
    ...
    Public Shared Function SetDefaultValues(ByVal sender As System.Web.UI.WebControls.FormView, ByVal e As System.EventArgs) As System.Web.UI.WebControls.FormView
      With sender
        ...
        'CType(.FindControl("F_LodgingAmount"), TextBox).Text = ""
      ...
      Return sender
    End Function
    Public Shared Function GetByCategoryID(ByVal CategoryID As Int32, ByVal CityTypeID As String, ByVal ForStartDate As DateTime) As SIS.TA.taD_Lodging
      Dim Results As SIS.TA.taD_Lodging = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spta_LG_D_LodgingSelectByCategoryID"
          ...
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@CityTypeID", SqlDbType.NVarChar, 7, CityTypeID)
