...
Namespace SIS.TA
  Partial Public Class taD_LCModes
    ...
    Public Shared Function SetDefaultValues(ByVal sender As System.Web.UI.WebControls.FormView, ByVal e As System.EventArgs) As System.Web.UI.WebControls.FormView
      ...
      Return sender
    End Function
    Public Shared Function GetByCategoryID(ByVal CategoryID As Int32, ByVal ForStartDate As DateTime) As SIS.TA.taD_LCModes
      Dim Results As SIS.TA.taD_LCModes = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spta_LG_D_LCModesSelectByCategoryID"
