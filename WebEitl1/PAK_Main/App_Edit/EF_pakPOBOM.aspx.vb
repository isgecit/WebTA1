  ...
  Protected Sub GVpakPOBItems_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GVpakPOBItems.RowCommand
    ...
    If e.CommandName.ToLower = "Deletewf".ToLower Then
      Try
        ...
        Dim SerialNo As Int32 = GVpakPOBItems.DataKeys(aVal(0)).Values("SerialNo")
        Dim BOMNo As Int32 = GVpakPOBItems.DataKeys(aVal(0)).Values("BOMNo")
        Dim ItemNo As Int32 = GVpakPOBItems.DataKeys(aVal(0)).Values("ItemNo")
        If aVal.Length > 1 Then
