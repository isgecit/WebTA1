<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_pakPOStatus.aspx.vb" Inherits="EF_pakPOStatus" title="Edit: PO States" %>
<asp:Content ID="CPHpakPOStatus" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelpakPOStatus" runat="server" Text="&nbsp;Edit: PO States"></asp:Label>
</div>
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "pakPOStatusGetByID"
  UpdateMethod="pakPOStatusUpdate"
  DeleteMethod="pakPOStatusDelete"
