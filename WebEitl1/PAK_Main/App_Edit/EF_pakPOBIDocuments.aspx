<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_pakPOBIDocuments.aspx.vb" Inherits="EF_pakPOBIDocuments" title="Edit: PO Item Documents" %>
<asp:Content ID="CPHpakPOBIDocuments" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelpakPOBIDocuments" runat="server" Text="&nbsp;Edit: PO Item Documents"></asp:Label>
</div>
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "pakPOBIDocumentsGetByID"
  UpdateMethod="UZ_pakPOBIDocumentsUpdate"
  DeleteMethod="UZ_pakPOBIDocumentsDelete"
