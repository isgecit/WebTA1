...
var script_pakSiteMtlIssD = {
    ...
    validated_FK_PAK_SiteIssueD_ProjectID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_pakSiteMtlIssD.validated_FK_PAK_SiteIssueD_ProjectID_main){
    ...
    validated_FK_PAK_SiteIssueD_IssueNo: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_pakSiteMtlIssD.validated_FK_PAK_SiteIssueD_IssueNo_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validated_FK_PAK_SiteIssueD_SiteMarkNo: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_pakSiteMtlIssD.validated_FK_PAK_SiteIssueD_SiteMarkNo_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
