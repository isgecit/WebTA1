<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="False" CodeFile="GF_pakSTCPOLR.aspx.vb" Inherits="GF_pakSTCPOLR" title="Maintain List: Submitted for TC" %>
...
<asp:UpdatePanel ID="UPNLpakSTCPOLR" runat="server">
  <ContentTemplate>
    ...
    <LGM:ToolBar0 
      ...
      AddUrl = "~/PAK_Main/App_Create/AF_pakSTCPOLR.aspx?skip=1"
      AddPostBack = "True"
