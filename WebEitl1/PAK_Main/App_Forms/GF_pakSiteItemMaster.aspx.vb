...
Partial Class GF_pakSiteItemMaster
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/PAK_Main/App_Display/DF_pakSiteItemMaster.aspx"
  Protected Sub Info_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
    Dim oBut As ImageButton = CType(sender, ImageButton)
    Dim aVal() As String = oBut.CommandArgument.ToString.Split(",".ToCharArray)
    Dim RedirectUrl As String = _InfoUrl  & "?ProjectID=" & aVal(0) & "&SiteMarkNo=" & aVal(1)
    Response.Redirect(RedirectUrl)
  End Sub
  Protected Sub GVpakSiteItemMaster_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GVpakSiteItemMaster.RowCommand
    If e.CommandName.ToLower = "lgedit".ToLower Then
      Try
        Dim ProjectID As String = GVpakSiteItemMaster.DataKeys(e.CommandArgument).Values("ProjectID")  
        Dim SiteMarkNo As String = GVpakSiteItemMaster.DataKeys(e.CommandArgument).Values("SiteMarkNo")  
        Dim RedirectUrl As String = TBLpakSiteItemMaster.EditUrl & "?ProjectID=" & ProjectID & "&SiteMarkNo=" & SiteMarkNo
        Response.Redirect(RedirectUrl)
    ...
    End If
  End Sub
  Protected Sub GVpakSiteItemMaster_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVpakSiteItemMaster.Init
    DataClassName = "GpakSiteItemMaster"
    SetGridView = GVpakSiteItemMaster
  End Sub
  ...
  Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    Dim validateScriptProjectID As String = "<script type=""text/javascript"">" & _
      ...
      "    validated_FK_PAK_SiteItemMaster_ProjectID_main = true;" & _
      "    validate_FK_PAK_SiteItemMaster_ProjectID(o);" & _
      "  }" & _
      "</script>"
    ...
    End If
    Dim validateScriptFK_PAK_SiteItemMaster_ProjectID As String = "<script type=""text/javascript"">" & _
      "  function validate_FK_PAK_SiteItemMaster_ProjectID(o) {" & _
      "    var value = o.id;" & _
      "    var ProjectID = $get('" & F_ProjectID.ClientID & "');" & _
      "    try{" & _
      "    if(ProjectID.value==''){" & _
      "      if(validated_FK_PAK_SiteItemMaster_ProjectID.main){" & _
      ...
      "    PageMethods.validate_FK_PAK_SiteItemMaster_ProjectID(value, validated_FK_PAK_SiteItemMaster_ProjectID);" & _
      "  }" & _
      "  validated_FK_PAK_SiteItemMaster_ProjectID_main = false;" & _
      "  function validated_FK_PAK_SiteItemMaster_ProjectID(result) {" & _
      ...
      "  }" & _
      "</script>"
    If Not Page.ClientScript.IsClientScriptBlockRegistered("validateFK_PAK_SiteItemMaster_ProjectID") Then
      Page.ClientScript.RegisterClientScriptBlock(GetType(System.String), "validateFK_PAK_SiteItemMaster_ProjectID", validateScriptFK_PAK_SiteItemMaster_ProjectID)
    End If
  End Sub
  <System.Web.Services.WebMethod()> _
