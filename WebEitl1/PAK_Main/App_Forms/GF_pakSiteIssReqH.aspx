<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="False" CodeFile="GF_pakSiteIssReqH.aspx.vb" Inherits="GF_pakSiteIssReqH" title="Maintain List: Site Issue Request" %>
<asp:Content ID="CPHpakSiteIssReqH" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabelpakSiteIssReqH" runat="server" Text="&nbsp;List: Site Issue Request"></asp:Label>
</div>
<div class="pagedata">
<asp:UpdatePanel ID="UPNLpakSiteIssReqH" runat="server">
  <ContentTemplate>
    ...
    <LGM:ToolBar0 
      ...
      ToolType = "lgNMGrid"
      EditUrl = "~/PAK_Main/App_Edit/EF_pakSiteIssReqH.aspx"
      AddUrl = "~/PAK_Main/App_Create/AF_pakSiteIssReqH.aspx?skip=1"
      ValidationGroup = "pakSiteIssReqH"
      runat = "server" />
    <asp:UpdateProgress ID="UPGSpakSiteIssReqH" runat="server" AssociatedUpdatePanelID="UPNLpakSiteIssReqH" DisplayAfter="100">
      <ProgressTemplate>
    ...
    <asp:GridView ID="GVpakSiteIssReqH" SkinID="gv_silver" runat="server" DataSourceID="ODSpakSiteIssReqH" DataKeyNames="ProjectID,IssueNo">
      <Columns>
    ...
    <asp:ObjectDataSource 
      ...
      SelectMethod = "UZ_pakSiteIssReqHSelectList"
      TypeName = "SIS.PAK.pakSiteIssReqH"
      SelectCountMethod = "pakSiteIssReqHSelectCount"
  ...
  <Triggers>
    <asp:AsyncPostBackTrigger ControlID="GVpakSiteIssReqH" EventName="PageIndexChanged" />
