...
Partial Class GF_pakSiteIssRecD
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/PAK_Main/App_Display/DF_pakSiteIssRecD.aspx"
  ...
  Protected Sub GVpakSiteIssRecD_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVpakSiteIssRecD.Init
    DataClassName = "GpakSiteIssRecD"
    SetGridView = GVpakSiteIssRecD
  End Sub
