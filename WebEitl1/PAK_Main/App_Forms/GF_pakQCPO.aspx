<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="False" CodeFile="GF_pakQCPO.aspx.vb" Inherits="GF_pakQCPO" title="Maintain List: Create Quality Clearance List & Offer For Clearance" %>
<asp:Content ID="CPHpakQCPO" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabelpakQCPO" runat="server" Text="&nbsp;List: Create Quality Clearance List & Offer For Clearance"></asp:Label>
</div>
<div class="pagedata">
