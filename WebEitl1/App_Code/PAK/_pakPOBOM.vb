...
Namespace SIS.PAK
  ...
  Partial Public Class pakPOBOM
    ...
    Private _FK_PAK_POBOM_AcceptedBy As SIS.QCM.qcmUsers = Nothing
    Private _FK_PAK_POBOM_FreezedBy As SIS.QCM.qcmUsers = Nothing
    Private _FK_PAK_POBOM_DivisionID As SIS.PAK.pakDivisions = Nothing
    Private _FK_PAK_POBOM_DocumentNo As SIS.PAK.pakDocuments = Nothing
    Private _FK_PAK_POBOM_ElementID As SIS.PAK.pakElements = Nothing
    Private _FK_PAK_POBOM_SerialNo As SIS.PAK.pakPO = Nothing
    Private _FK_PAK_POBOM_StatusID As SIS.PAK.pakPOBOMStatus = Nothing
    Private _FK_PAK_POBOM_UOMQuantity As SIS.PAK.pakUnits = Nothing
    Private _FK_PAK_POBOM_UOMWeight As SIS.PAK.pakUnits = Nothing
    ...
    Public Class PKpakPOBOM
      ...
      End Property
    End Class
    Public ReadOnly Property FK_PAK_POBOM_AcceptedBy() As SIS.QCM.qcmUsers
      Get
        If _FK_PAK_POBOM_AcceptedBy Is Nothing Then
          _FK_PAK_POBOM_AcceptedBy = SIS.QCM.qcmUsers.qcmUsersGetByID(_AcceptedBy)
        End If
        Return _FK_PAK_POBOM_AcceptedBy
      End Get
    End Property
    Public ReadOnly Property FK_PAK_POBOM_FreezedBy() As SIS.QCM.qcmUsers
      Get
        If _FK_PAK_POBOM_FreezedBy Is Nothing Then
          _FK_PAK_POBOM_FreezedBy = SIS.QCM.qcmUsers.qcmUsersGetByID(_FreezedBy)
        End If
        Return _FK_PAK_POBOM_FreezedBy
      End Get
    End Property
    Public ReadOnly Property FK_PAK_POBOM_DivisionID() As SIS.PAK.pakDivisions
      Get
        If _FK_PAK_POBOM_DivisionID Is Nothing Then
          _FK_PAK_POBOM_DivisionID = SIS.PAK.pakDivisions.pakDivisionsGetByID(_DivisionID)
        End If
        Return _FK_PAK_POBOM_DivisionID
      End Get
    End Property
    Public ReadOnly Property FK_PAK_POBOM_DocumentNo() As SIS.PAK.pakDocuments
      Get
        If _FK_PAK_POBOM_DocumentNo Is Nothing Then
          _FK_PAK_POBOM_DocumentNo = SIS.PAK.pakDocuments.pakDocumentsGetByID(_DocumentNo)
        End If
        Return _FK_PAK_POBOM_DocumentNo
      End Get
    End Property
    Public ReadOnly Property FK_PAK_POBOM_ElementID() As SIS.PAK.pakElements
      Get
        If _FK_PAK_POBOM_ElementID Is Nothing Then
          _FK_PAK_POBOM_ElementID = SIS.PAK.pakElements.pakElementsGetByID(_ElementID)
        End If
        Return _FK_PAK_POBOM_ElementID
      End Get
    End Property
    Public ReadOnly Property FK_PAK_POBOM_SerialNo() As SIS.PAK.pakPO
      Get
        If _FK_PAK_POBOM_SerialNo Is Nothing Then
          _FK_PAK_POBOM_SerialNo = SIS.PAK.pakPO.pakPOGetByID(_SerialNo)
        End If
        Return _FK_PAK_POBOM_SerialNo
      End Get
    End Property
    Public ReadOnly Property FK_PAK_POBOM_StatusID() As SIS.PAK.pakPOBOMStatus
      Get
        If _FK_PAK_POBOM_StatusID Is Nothing Then
          _FK_PAK_POBOM_StatusID = SIS.PAK.pakPOBOMStatus.pakPOBOMStatusGetByID(_StatusID)
        End If
        Return _FK_PAK_POBOM_StatusID
      End Get
    End Property
    Public ReadOnly Property FK_PAK_POBOM_UOMQuantity() As SIS.PAK.pakUnits
      Get
        If _FK_PAK_POBOM_UOMQuantity Is Nothing Then
          _FK_PAK_POBOM_UOMQuantity = SIS.PAK.pakUnits.pakUnitsGetByID(_UOMQuantity)
        End If
        Return _FK_PAK_POBOM_UOMQuantity
      End Get
    End Property
    Public ReadOnly Property FK_PAK_POBOM_UOMWeight() As SIS.PAK.pakUnits
      Get
        If _FK_PAK_POBOM_UOMWeight Is Nothing Then
          _FK_PAK_POBOM_UOMWeight = SIS.PAK.pakUnits.pakUnitsGetByID(_UOMWeight)
        End If
        Return _FK_PAK_POBOM_UOMWeight
      End Get
    End Property
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function pakPOBOMSelectList(ByVal OrderBy As String) As List(Of SIS.PAK.pakPOBOM)
      Dim Results As List(Of SIS.PAK.pakPOBOM) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "sppakPOBOMSelectList"
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function pakPOBOMGetNewRecord() As SIS.PAK.pakPOBOM
      Return New SIS.PAK.pakPOBOM()
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    ...
    Public Shared Function pakPOBOMInsert(ByVal Record As SIS.PAK.pakPOBOM) As SIS.PAK.pakPOBOM
      Dim _Rec As SIS.PAK.pakPOBOM = SIS.PAK.pakPOBOM.pakPOBOMGetNewRecord()
      With _Rec
    ...
    End Function
'    Autocomplete Method
    Public Shared Function SelectpakPOBOMAutoCompleteList(ByVal Prefix As String, ByVal count As Integer, ByVal contextKey As String) As String()
      Dim Results As List(Of String) = Nothing
      Dim aVal() As String = contextKey.Split("|".ToCharArray)
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "sppakPOBOMAutoCompleteList"
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@LoginID", SqlDbType.NvarChar, 9, HttpContext.Current.Session("LoginID"))
          ...
          End If
          While (Reader.Read())
            Dim Tmp As SIS.PAK.pakPOBOM = New SIS.PAK.pakPOBOM(Reader)
