...
Namespace SIS.PAK
  ...
  Partial Public Class pakPO
    ...
    Public Shared Function pakPOSelectList(ByVal OrderBy As String) As List(Of SIS.PAK.pakPO)
      Dim Results As List(Of SIS.PAK.pakPO) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "sppakPOSelectList"
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetBySupplierID(ByVal SupplierID As String, ByVal OrderBy as String) As List(Of SIS.PAK.pakPO)
      Dim Results As List(Of SIS.PAK.pakPO) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "sppakPOSelectBySupplierID"
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByProjectID(ByVal ProjectID As String, ByVal OrderBy as String) As List(Of SIS.PAK.pakPO)
      Dim Results As List(Of SIS.PAK.pakPO) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "sppakPOSelectByProjectID"
    ...
    Public Shared Function pakPOSelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal POTypeID As Int32, ByVal SupplierID As String, ByVal ProjectID As String, ByVal BuyerID As String, ByVal POStatusID As Int32, ByVal IssuedBy As String) As List(Of SIS.PAK.pakPO)
      ...
      Return Results
    End Function
    Public Shared Function pakPOSelectCount(ByVal SearchState As Boolean, ByVal SearchText As String, ByVal POTypeID As Int32, ByVal SupplierID As String, ByVal ProjectID As String, ByVal BuyerID As String, ByVal POStatusID As Int32, ByVal IssuedBy As String) As Integer
      Return _RecordCount
    End Function
    ...
    Public Shared Function pakPOInsert(ByVal Record As SIS.PAK.pakPO) As SIS.PAK.pakPO
      Dim _Rec As SIS.PAK.pakPO = SIS.PAK.pakPO.pakPOGetNewRecord()
      With _Rec
      ...
      End With
      Return SIS.PAK.pakPO.InsertData(_Rec)
    End Function
    Public Shared Function InsertData(ByVal Record As SIS.PAK.pakPO) As SIS.PAK.pakPO
      '1. Get QCRequired Configuration
      Dim QCRequired As Boolean = False
      QCRequired = Convert.ToBoolean(ConfigurationManager.AppSettings("QCRequired"))
      Record.QCRequired = QCRequired
      '==============================
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "sppakPOInsert"
    ...
    Public Shared Function pakPOUpdate(ByVal Record As SIS.PAK.pakPO) As SIS.PAK.pakPO
    ...
    Public Shared Function pakPODelete(ByVal Record As SIS.PAK.pakPO) As Int32
      Dim _Result as Integer = 0
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "sppakPODelete"
    ...
    End Function
'    Autocomplete Method
    Public Shared Function SelectpakPOAutoCompleteList(ByVal Prefix As String, ByVal count As Integer, ByVal contextKey As String) As String()
      Dim Results As List(Of String) = Nothing
      Dim aVal() As String = contextKey.Split("|".ToCharArray)
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "sppakPOAutoCompleteList"
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@DivisionID",SqlDbType.Int,10, Global.System.Web.HttpContext.Current.Session("DivisionID"))
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@LoginID", SqlDbType.NvarChar, 9, HttpContext.Current.Session("LoginID"))
          ...
          End If
          While (Reader.Read())
            Dim Tmp As SIS.PAK.pakPO = New SIS.PAK.pakPO(Reader)
