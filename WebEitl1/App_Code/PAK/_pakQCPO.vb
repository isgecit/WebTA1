...
Namespace SIS.PAK
  ...
  Partial Public Class pakQCPO
    ...
    Public Shared Function pakQCPOGetNewRecord() As SIS.PAK.pakQCPO
      Return New SIS.PAK.pakQCPO()
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function pakQCPOSelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal ProjectID As String, ByVal BuyerID As String, ByVal IssuedBy As String) As List(Of SIS.PAK.pakQCPO)
      ...
      Return Results
    End Function
    Public Shared Function pakQCPOSelectCount(ByVal SearchState As Boolean, ByVal SearchText As String, ByVal ProjectID As String, ByVal BuyerID As String, ByVal IssuedBy As String) As Integer
      Return RecordCount
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function pakQCPOGetByID(ByVal SerialNo As Int32) As SIS.PAK.pakQCPO
      Dim Results As SIS.PAK.pakQCPO = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          ...
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          If Reader.Read() Then
            Results = New SIS.PAK.pakQCPO(Reader)
          End If
          Reader.Close()
        End Using
      End Using
    ...
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function pakQCPOGetByID(ByVal SerialNo As Int32, ByVal Filter_ProjectID As String, ByVal Filter_BuyerID As String, ByVal Filter_IssuedBy As String) As SIS.PAK.pakQCPO
      Dim Results As SIS.PAK.pakQCPO = SIS.PAK.pakQCPO.pakQCPOGetByID(SerialNo)
      Return Results
    End Function
    <DataObjectMethod(DataObjectMethodType.Update, True)> _
    Public Shared Function pakQCPOUpdate(ByVal Record As SIS.PAK.pakQCPO) As SIS.PAK.pakQCPO
      Dim _Rec As SIS.PAK.pakQCPO = SIS.PAK.pakQCPO.pakQCPOGetByID(Record.SerialNo)
      With _Rec
        ...
        .POFOR = "PK"
      End With
      Return SIS.PAK.pakQCPO.UpdateData(_Rec)
    End Function
