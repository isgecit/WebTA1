<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_erpApprovalByHOD.aspx.vb" Inherits="EF_erpApprovalByHOD" title="Edit: Approve Change Request" %>
...
<ContentTemplate>
  <asp:Label ID="LabelerpApprovalByHOD" runat="server" Text="&nbsp;Edit: Approve Change Request" Width="100%" CssClass="sis_formheading"></asp:Label>
  <LGM:ToolBar0 
    ...
    EnableDelete = "False"
    EnablePrint = "True"
    PrintUrl = "../App_Print/RP_erpApprovalByHOD.aspx?pk="
    ...
    <script type="text/javascript">
      ...
      function script_download(id, id1, typ) {
      	pcnt = pcnt + 1;
      	var nam = 'wdwd' + pcnt;
      	var url = self.location.href.replace('App_Edit/EF_erpApprovalByHOD.aspx', 'App_Downloads/filedownload.aspx');
      	url = url + '&id=' + id + '&typ=' + typ + '&id1=' + id1;
      	window.open(url, nam, 'left=20,top=20,width=100,height=100,toolbar=1,resizable=1,scrollbars=1');
      	return false;
      }
    </script>
<asp:FormView ID="FVerpApprovalByHOD"
	runat = "server"
	DataKeyNames = "ApplID,RequestID"
	DataSourceID = "ODSerpApprovalByHOD"
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "erpApprovalByHODGetByID"
  UpdateMethod="erpApprovalByHODUpdate"
  OldValuesParameterFormatString = "original_{0}"
