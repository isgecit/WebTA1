...
var script_erpEvaluateByESC = {
		...
		validate_StatusID: function(sender) {
		  ...
		  this.validated_FK_ERP_ChaneRequest_StatusID_main = true;
		  this.validate_FK_ERP_ChaneRequest_StatusID(sender,Prefix);
		  },
		validate_PriorityID: function(sender) {
		  var Prefix = sender.id.replace('PriorityID','');
		  this.validated_FK_ERP_ChaneRequest_PriorityID_main = true;
		  this.validate_FK_ERP_ChaneRequest_PriorityID(sender,Prefix);
		  },
		temp: function() {
		}
		}
