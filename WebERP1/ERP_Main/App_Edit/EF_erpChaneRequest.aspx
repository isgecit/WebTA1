<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_erpChaneRequest.aspx.vb" Inherits="EF_erpChaneRequest" title="Edit: Change Request" %>
...
<ContentTemplate>
  <asp:Label ID="LabelerpChaneRequest" runat="server" Text="&nbsp;Edit: Change Request" Width="100%" CssClass="sis_formheading"></asp:Label>
  <LGM:ToolBar0 
    ID = "TBLerpChaneRequest"
    ToolType = "lgNMEdit"
    UpdateAndStay = "False"
    EnablePrint = "True"
    PrintUrl = "../App_Print/RP_erpChaneRequest.aspx?pk="
    ...
    <script type="text/javascript">
      ...
      function script_download(id, id1, typ) {
      	pcnt = pcnt + 1;
      	var nam = 'wdwd' + pcnt;
      	var url = self.location.href.replace('App_Edit/EF_erpChaneRequest.aspx', 'App_Downloads/filedownload.aspx');
    ...
    <br />
        ...
        <td>
          &nbsp;</td>
            ...
            Width="700px" Height="60px" TextMode="MultiLine"
						CssClass = "mytxt"
						onfocus = "return this.select();"
						ValidationGroup="erpChaneRequest"
            onblur= "this.value=this.value.replace(/\'/g,'');"
...
<asp:UpdatePanel ID="UPNLerpRequestAttachments" runat="server">
  <ContentTemplate>
    ...
    <table width="100%"><tr><td class="sis_formview"> 
			<table id="F_Upload" runat="server" >
				<tr>
					<td>
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "erpChaneRequestGetByID"
  UpdateMethod="UZ_erpChaneRequestUpdate"
  DeleteMethod="erpChaneRequestDelete"
  OldValuesParameterFormatString = "original_{0}"
