Partial Class GF_erpCreateTPTBill
  ...
  End Sub
	Protected Sub GVerpCreateTPTBill_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GVerpCreateTPTBill.RowCommand
		...
		If e.CommandName.ToLower = "lgcopy".ToLower Then
			Try
				...
				Dim oCT As SIS.ERP.erpCreateTPTBill = SIS.ERP.erpCreateTPTBill.erpCreateTPTBillGetByID(SerialNo)
				With oCT
					.SerialNo = 0
					.TPTBillNo = oCT.TPTBillNo
					.TPTBillDate = oCT.TPTBillDate
					.TPTBillReceivedOn = oCT.TPTBillReceivedOn
		...
		If e.CommandName.ToLower = "initiatewf".ToLower Then
			Try
				Dim SerialNo As Int32 = GVerpCreateTPTBill.DataKeys(e.CommandArgument).Values("SerialNo")
				SIS.ERP.erpCreateTPTBill.InitiateWF(SerialNo)
				GVerpCreateTPTBill.DataBind()
			Catch ex As Exception
		...
		If e.CommandName.ToLower = "approvewf".ToLower Then
			Try
				Dim SerialNo As Int32 = GVerpCreateTPTBill.DataKeys(e.CommandArgument).Values("SerialNo")
				SIS.ERP.erpCreateTPTBill.ApproveWF(SerialNo)
				GVerpCreateTPTBill.DataBind()
			Catch ex As Exception
				ErrorMsg.Text = ex.Message
				ErrorMsg.Visible = True
		...
		If e.CommandName.ToLower = "rejectwf".ToLower Then
			Try
				Dim SerialNo As Int32 = GVerpCreateTPTBill.DataKeys(e.CommandArgument).Values("SerialNo")
				SIS.ERP.erpCreateTPTBill.RejectWF(SerialNo)
				GVerpCreateTPTBill.DataBind()
			Catch ex As Exception
				ErrorMsg.Text = ex.Message
				ErrorMsg.Visible = True
		...
		If e.CommandName.ToLower = "completewf".ToLower Then
			Try
				Dim SerialNo As Int32 = GVerpCreateTPTBill.DataKeys(e.CommandArgument).Values("SerialNo")
				SIS.ERP.erpCreateTPTBill.CompleteWF(SerialNo)
				GVerpCreateTPTBill.DataBind()
			Catch ex As Exception
				ErrorMsg.Text = ex.Message
				ErrorMsg.Visible = True
		...
		End If
	End Sub
  Protected Sub GVerpCreateTPTBill_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVerpCreateTPTBill.Init
    DataClassName = "GerpCreateTPTBill"
    SetGridView = GVerpCreateTPTBill
  End Sub
