<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_erpEvaluateByESC.aspx.vb" Inherits="GF_erpEvaluateByESC" title="Maintain List: Evaluation By ESC" %>
<asp:Content ID="CPHerpEvaluateByESC" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabeltaBH" runat="server" Text="&nbsp;List: Evaluation By ESC"></asp:Label>
</div>
<div class="pagedata">
<asp:UpdatePanel ID="UPNLerpEvaluateByESC" runat="server">
  <ContentTemplate>
    ...
    <LGM:ToolBar0 
      ...
      ToolType = "lgNMGrid"
      EditUrl = "~/ERP_Main/App_Edit/EF_erpEvaluateByESC.aspx"
      EnableAdd = "False"
      ValidationGroup = "erpEvaluateByESC"
      SkinID = "tbl_blue"
      runat = "server" />
    <asp:UpdateProgress ID="UPGSerpEvaluateByESC" runat="server" AssociatedUpdatePanelID="UPNLerpEvaluateByESC" DisplayAfter="100">
      <ProgressTemplate>
    ...
    <asp:GridView ID="GVerpEvaluateByESC" SkinID="gv_silver" BorderColor="#A9A9A9" width="100%" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="ODSerpEvaluateByESC" DataKeyNames="ApplID,RequestID">
      <Columns>
        ...
        <asp:TemplateField HeaderText="PRIORITY" SortExpression="ERP_RequestPriority4_Description">
          <ItemTemplate>
             <asp:Label ID="L_PriorityID" runat="server" ForeColor='<%# EVal("ForeColor") %>' Title='<%# EVal("PriorityID") %>' Text='<%# Eval("ERP_RequestPriority4_Description") %>'></asp:Label>
          </ItemTemplate>
          <HeaderStyle Width="100px" />
        </asp:TemplateField>
        <asp:TemplateField HeaderText="MSL Portal Number" SortExpression="MSLPortalNumber">
          <ItemTemplate>
            <asp:Label ID="LabelMSLPortalNumber" runat="server" ForeColor='<%# EVal("ForeColor") %>' Text='<%# Bind("MSLPortalNumber") %>'></asp:Label>
          </ItemTemplate>
        <HeaderStyle Width="100px" />
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Planned Delivery Date" SortExpression="PlannedDeliveryDate">
          <ItemTemplate>
            <asp:Label ID="LabelPlannedDeliveryDate" runat="server" ForeColor='<%# EVal("ForeColor") %>' Text='<%# Bind("PlannedDeliveryDate") %>'></asp:Label>
          </ItemTemplate>
        <HeaderStyle Width="80px" />
        </asp:TemplateField>
    ...
    <asp:ObjectDataSource 
      ...
      SelectMethod = "UZ_erpEvaluateByESCSelectList"
      TypeName = "SIS.ERP.erpEvaluateByESC"
      SelectCountMethod = "erpEvaluateByESCSelectCount"
  ...
  <Triggers>
    <asp:AsyncPostBackTrigger ControlID="GVerpEvaluateByESC" EventName="PageIndexChanged" />
