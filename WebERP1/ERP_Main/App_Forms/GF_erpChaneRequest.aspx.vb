Partial Class GF_erpChaneRequest
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/ERP_Main/App_Display/DF_erpChaneRequest.aspx"
  ...
  End Sub
  Protected Sub GVerpChaneRequest_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GVerpChaneRequest.RowCommand
		If e.CommandName.ToLower = "lgedit".ToLower Then
			Try
				Dim ApplID As Int32 = GVerpChaneRequest.DataKeys(e.CommandArgument).Values("ApplID")  
				Dim RequestID As Int32 = GVerpChaneRequest.DataKeys(e.CommandArgument).Values("RequestID")  
				Dim RedirectUrl As String = TBLerpChaneRequest.EditUrl & "?ApplID=" & ApplID & "&RequestID=" & RequestID
				Response.Redirect(RedirectUrl)
		...
		If e.CommandName.ToLower = "initiatewf".ToLower Then
			Try
				Dim ApplID As Int32 = GVerpChaneRequest.DataKeys(e.CommandArgument).Values("ApplID")  
				Dim RequestID As Int32 = GVerpChaneRequest.DataKeys(e.CommandArgument).Values("RequestID")  
				SIS.ERP.erpChaneRequest.InitiateWF(ApplID, RequestID)
				GVerpChaneRequest.DataBind()
			Catch ex As Exception
			End Try
		End If
  End Sub
  Protected Sub GVerpChaneRequest_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVerpChaneRequest.Init
    DataClassName = "GerpChaneRequest"
    SetGridView = GVerpChaneRequest
  End Sub
