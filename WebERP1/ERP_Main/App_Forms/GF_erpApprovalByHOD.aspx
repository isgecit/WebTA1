<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_erpApprovalByHOD.aspx.vb" Inherits="GF_erpApprovalByHOD" title="Maintain List: Approve Change Request" %>
<asp:Content ID="CPHerpApprovalByHOD" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabeltaBH" runat="server" Text="&nbsp;List: Approve Change Request"></asp:Label>
</div>
<div class="pagedata">
<asp:UpdatePanel ID="UPNLerpApprovalByHOD" runat="server">
  <ContentTemplate>
    <table width="100%"><tr><td class="sis_formview"> 
    <LGM:ToolBar0 
      ID = "TBLerpApprovalByHOD"
      ToolType = "lgNMGrid"
      EditUrl = "~/ERP_Main/App_Edit/EF_erpApprovalByHOD.aspx"
      EnableAdd = "False"
      ValidationGroup = "erpApprovalByHOD"
      SkinID = "tbl_blue"
      runat = "server" />
    <asp:UpdateProgress ID="UPGSerpApprovalByHOD" runat="server" AssociatedUpdatePanelID="UPNLerpApprovalByHOD" DisplayAfter="100">
      <ProgressTemplate>
   ...
   var script_ReturnRemarks = {
    ...
    <asp:GridView ID="GVerpApprovalByHOD" SkinID="gv_silver" BorderColor="#A9A9A9" width="100%" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="ODSerpApprovalByHOD" DataKeyNames="ApplID,RequestID">
      <Columns>
    ...
    <asp:ObjectDataSource 
      ID = "ODSerpApprovalByHOD"
      runat = "server"
      DataObjectTypeName = "SIS.ERP.erpApprovalByHOD"
      OldValuesParameterFormatString = "original_{0}"
      SelectMethod = "UZ_erpApprovalByHODSelectList"
      TypeName = "SIS.ERP.erpApprovalByHOD"
      SelectCountMethod = "erpApprovalByHODSelectCount"
  ...
  <Triggers>
    <asp:AsyncPostBackTrigger ControlID="GVerpApprovalByHOD" EventName="PageIndexChanged" />
