Partial Class GF_erpEvaluateByESC
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/ERP_Main/App_Display/DF_erpEvaluateByESC.aspx"
  ...
  End Sub
  Protected Sub GVerpEvaluateByESC_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GVerpEvaluateByESC.RowCommand
		If e.CommandName.ToLower = "lgedit".ToLower Then
			Try
				Dim ApplID As Int32 = GVerpEvaluateByESC.DataKeys(e.CommandArgument).Values("ApplID")  
				Dim RequestID As Int32 = GVerpEvaluateByESC.DataKeys(e.CommandArgument).Values("RequestID")  
				Dim RedirectUrl As String = TBLerpEvaluateByESC.EditUrl & "?ApplID=" & ApplID & "&RequestID=" & RequestID
				Response.Redirect(RedirectUrl)
		...
		If e.CommandName.ToLower = "initiatewf".ToLower Then
			Try
				Dim ApplID As Int32 = GVerpEvaluateByESC.DataKeys(e.CommandArgument).Values("ApplID")  
				Dim RequestID As Int32 = GVerpEvaluateByESC.DataKeys(e.CommandArgument).Values("RequestID")  
				SIS.ERP.erpEvaluateByESC.InitiateWF(ApplID, RequestID)
				GVerpEvaluateByESC.DataBind()
			Catch ex As Exception
			End Try
		End If
  End Sub
  Protected Sub GVerpEvaluateByESC_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVerpEvaluateByESC.Init
    DataClassName = "GerpEvaluateByESC"
    SetGridView = GVerpEvaluateByESC
  End Sub
