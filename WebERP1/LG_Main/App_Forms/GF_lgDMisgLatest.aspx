<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_lgDMisgLatest.aspx.vb" Inherits="GF_lgDMisgLatest" title="Maintain List: Latest BaaN Document" %>
<asp:Content ID="CPHlgDMisg" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="page">
<asp:UpdatePanel ID="UPNLlgDMisg" runat="server">
  <ContentTemplate>
    <asp:Label ID="LabellgDMisg" runat="server" Text="&nbsp;List: Latest BaaN Document" Width="100%" CssClass="sis_formheading"></asp:Label>
    <table width="100%"><tr><td class="sis_formview"> 
    <LGM:ToolBar0 
      ID = "TBLlgDMisg"
      ToolType = "lgNMGrid"
      EditUrl = "~/LG_Main/App_Edit/EF_lgDMisgLatest.aspx"
      EnableAdd = "False"
    ...
    <asp:ObjectDataSource 
      ...
      SelectMethod = "lgDMisgSelectLatest"
