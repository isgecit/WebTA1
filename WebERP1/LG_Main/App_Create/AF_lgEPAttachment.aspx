<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AF_lgEPAttachment.aspx.vb" Inherits="AF_lgEPAttachment" title="Add: EPM Attachment" %>
...
<asp:UpdatePanel ID="UPNLlgEPAttachment" runat="server" >
  <ContentTemplate>
  <asp:Label ID="LabellgEPAttachment" runat="server" Text="&nbsp;Add: EPM Attachment" Width="100%" CssClass="sis_formheading"></asp:Label>
  <LGM:ToolBar0 
...
<asp:FormView ID="FVlgEPAttachment"
	...
	<InsertItemTemplate>
    <br />
    <asp:Label ID="L_ErrMsglgEPAttachment" runat="server" ForeColor="Red" Font-Bold="true" Text=""></asp:Label>
		<table>
			<tr>
				<td class="alignright">
        ...
        <td>
            ...
            ToolTip="Enter value for DocPK."
						ValidationGroup = "lgEPAttachment"
            onblur= "script_lgEPAttachment.validate_DocPK(this);"
						Runat="Server" />
					<asp:Label
						ID = "F_DocPK_Display"
          ...
          <AJX:AutoCompleteExtender
            ...
            OnClientItemSelected="script_lgEPAttachment.ACEDocPK_Selected"
            OnClientPopulating="script_lgEPAttachment.ACEDocPK_Populating"
            OnClientPopulated="script_lgEPAttachment.ACEDocPK_Populated"
...
<asp:ObjectDataSource 
  ...
  InsertMethod="lgEPAttachmentInsert"
