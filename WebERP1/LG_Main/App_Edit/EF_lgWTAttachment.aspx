<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_lgWTAttachment.aspx.vb" Inherits="EF_lgWTAttachment" title="Edit: WT Attachments" %>
<asp:Content ID="CPHlgWTAttachment" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="page">
<asp:UpdatePanel ID="UPNLlgWTAttachment" runat="server" >
<ContentTemplate>
  <asp:Label ID="LabellgWTAttachment" runat="server" Text="&nbsp;Edit: WT Attachments" Width="100%" CssClass="sis_formheading"></asp:Label>
  <LGM:ToolBar0 
    ...
    EnablePrint = "True"
    EnableSave="false"
    PrintUrl = "../App_Print/RP_lgWTAttachment.aspx?pk="
...
<asp:FormView ID="FVlgWTAttachment"
	runat = "server"
	DataKeyNames = "DocPK,FilePK"
	DataSourceID = "ODSlgWTAttachment"
    ...
    <br />
        ...
        <td>
            ...
            ToolTip="Enter value for Project ID."
						ValidationGroup = "lgWTAttachment"
            onblur= "script_lgWTAttachment.validate_ProjectID(this);"
						Runat="Server" />
					<asp:Label
          ...
          <AJX:AutoCompleteExtender
            ...
            OnClientItemSelected="script_lgWTAttachment.ACEProjectID_Selected"
            OnClientPopulating="script_lgWTAttachment.ACEProjectID_Populating"
            OnClientPopulated="script_lgWTAttachment.ACEProjectID_Populated"
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "lgWTAttachmentGetByID"
  UpdateMethod="lgWTAttachmentUpdate"
