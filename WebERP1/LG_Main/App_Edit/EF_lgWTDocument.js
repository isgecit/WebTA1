...
var script_lgWTDocument = {
		...
		validate_ProjectID: function(sender) {
		  ...
		  this.validated_FK_LG_WTDocument_ProjectID_main = true;
		  this.validate_FK_LG_WTDocument_ProjectID(sender,Prefix);
		  },
		validate_FK_LG_WTDocument_ProjectID: function(o,Prefix) {
		  var value = o.id;
		  var ProjectID = $get(Prefix + 'ProjectID');
		  if(ProjectID.value==''){
		    if(this.validated_FK_LG_WTDocument_ProjectID_main){
		  ...
		  value = value + ',' + ProjectID.value ;
		    ...
		    PageMethods.validate_FK_LG_WTDocument_ProjectID(value, this.validated_FK_LG_WTDocument_ProjectID);
		  },
		validated_FK_LG_WTDocument_ProjectID_main: false,
		validated_FK_LG_WTDocument_ProjectID: function(result) {
		  var p = result.split('|');
		  var o = $get(p[1]);
		  if(script_lgWTDocument.validated_FK_LG_WTDocument_ProjectID_main){
