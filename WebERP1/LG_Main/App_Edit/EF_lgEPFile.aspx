<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_lgEPFile.aspx.vb" Inherits="EF_lgEPFile" title="Edit: EPM File Details" %>
<asp:Content ID="CPHlgEPFile" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="page">
<asp:UpdatePanel ID="UPNLlgEPFile" runat="server" >
<ContentTemplate>
  <asp:Label ID="LabellgEPFile" runat="server" Text="&nbsp;Edit: EPM File Details" Width="100%" CssClass="sis_formheading"></asp:Label>
  <LGM:ToolBar0 
    ID = "TBLlgEPFile"
    ToolType = "lgNMEdit"
    UpdateAndStay = "False"
    ...
    EnablePrint = "True"
    EnableSave="false"
    PrintUrl = "../App_Print/RP_lgEPFile.aspx?pk="
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "lgEPFileGetByID"
  UpdateMethod="lgEPFileUpdate"
