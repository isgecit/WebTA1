...
var script_lgEPDCR = {
		...
		validate_ProjectID: function(sender) {
		  ...
		  this.validated_FK_LG_EPDCR_ProjectID_main = true;
		  this.validate_FK_LG_EPDCR_ProjectID(sender,Prefix);
		  },
		validate_FK_LG_EPDCR_ProjectID: function(o,Prefix) {
		  var value = o.id;
		  var ProjectID = $get(Prefix + 'ProjectID');
		  if(ProjectID.value==''){
		    if(this.validated_FK_LG_EPDCR_ProjectID_main){
		  ...
		  value = value + ',' + ProjectID.value ;
		    ...
		    PageMethods.validate_FK_LG_EPDCR_ProjectID(value, this.validated_FK_LG_EPDCR_ProjectID);
		  },
		validated_FK_LG_EPDCR_ProjectID_main: false,
		validated_FK_LG_EPDCR_ProjectID: function(result) {
		  var p = result.split('|');
		  var o = $get(p[1]);
		  if(script_lgEPDCR.validated_FK_LG_EPDCR_ProjectID_main){
