<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_lgWTDCR.aspx.vb" Inherits="EF_lgWTDCR" title="Edit: WT DCR" %>
<asp:Content ID="CPHlgWTDCR" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="page">
<asp:UpdatePanel ID="UPNLlgWTDCR" runat="server" >
<ContentTemplate>
  <asp:Label ID="LabellgWTDCR" runat="server" Text="&nbsp;Edit: WT DCR" Width="100%" CssClass="sis_formheading"></asp:Label>
  <LGM:ToolBar0 
    ID = "TBLlgWTDCR"
    ToolType = "lgNMEdit"
    UpdateAndStay = "False"
    ...
    EnablePrint = "True"
    EnableSave="false"
    PrintUrl = "../App_Print/RP_lgWTDCR.aspx?pk="
...
<asp:FormView ID="FVlgWTDCR"
	runat = "server"
	DataKeyNames = "DocPK,DCRID,DCRLine"
	DataSourceID = "ODSlgWTDCR"
    ...
    <br />
        ...
        <td>
            ...
            ToolTip="Enter value for Project ID."
						ValidationGroup = "lgWTDCR"
            onblur= "script_lgWTDCR.validate_ProjectID(this);"
						Runat="Server" />
					<asp:Label
          ...
          <AJX:AutoCompleteExtender
            ...
            OnClientItemSelected="script_lgWTDCR.ACEProjectID_Selected"
            OnClientPopulating="script_lgWTDCR.ACEProjectID_Populating"
            OnClientPopulated="script_lgWTDCR.ACEProjectID_Populated"
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "lgWTDCRGetByID"
  UpdateMethod="lgWTDCRUpdate"
