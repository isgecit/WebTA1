<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_lgDMisgLatest.aspx.vb" Inherits="EF_lgDMisgLatest" title="Edit: Latest BaaN Document" %>
<asp:Content ID="CPHlgDMisg" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="page">
<asp:UpdatePanel ID="UPNLlgDMisg" runat="server" >
<ContentTemplate>
  <asp:Label ID="LabellgDMisg" runat="server" Text="&nbsp;Edit: Latest BaaN Document" Width="100%" CssClass="sis_formheading"></asp:Label>
  <LGM:ToolBar0 
    ID = "TBLlgDMisg"
    ToolType = "lgNMEdit"
    UpdateAndStay = "False"
