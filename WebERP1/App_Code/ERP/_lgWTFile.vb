...
Namespace SIS.LG
  ...
  Partial Public Class lgWTFile
    ...
    Private _FK_LG_WTFile_ProjectID As SIS.LG.lgProjects = Nothing
    Private _FK_LG_WTFile_DocPK As SIS.LG.lgWTDocument = Nothing
    ...
    Public Class PKlgWTFile
			...
			End Property
    End Class
    Public ReadOnly Property FK_LG_WTFile_ProjectID() As SIS.LG.lgProjects
      Get
        If _FK_LG_WTFile_ProjectID Is Nothing Then
          _FK_LG_WTFile_ProjectID = SIS.LG.lgProjects.lgProjectsGetByID(_ProjectID)
        End If
        Return _FK_LG_WTFile_ProjectID
      End Get
    End Property
    Public ReadOnly Property FK_LG_WTFile_DocPK() As SIS.LG.lgWTDocument
      Get
        If _FK_LG_WTFile_DocPK Is Nothing Then
          _FK_LG_WTFile_DocPK = SIS.LG.lgWTDocument.lgWTDocumentGetByID(_DocPK)
        End If
        Return _FK_LG_WTFile_DocPK
      End Get
    End Property
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function lgWTFileSelectList(ByVal OrderBy As String) As List(Of SIS.LG.lgWTFile)
      Dim Results As List(Of SIS.LG.lgWTFile) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "splgWTFileSelectList"
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function lgWTFileGetNewRecord() As SIS.LG.lgWTFile
      Return New SIS.LG.lgWTFile()
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function lgWTFileGetByID(ByVal DocPK As Int64, ByVal FilePK As Int64) As SIS.LG.lgWTFile
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByDocPK(ByVal DocPK As Int64, ByVal OrderBy as String) As List(Of SIS.LG.lgWTFile)
      Dim Results As List(Of SIS.LG.lgWTFile) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "splgWTFileSelectByDocPK"
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@DocPK",SqlDbType.BigInt,DocPK.ToString.Length, DocPK)
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@LoginID", SqlDbType.NvarChar, 9, HttpContext.Current.Session("LoginID"))
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@OrderBy", SqlDbType.NVarChar, 50, OrderBy)
          Cmd.Parameters.Add("@RecordCount", SqlDbType.Int)
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByProjectID(ByVal ProjectID As String, ByVal OrderBy as String) As List(Of SIS.LG.lgWTFile)
      Dim Results As List(Of SIS.LG.lgWTFile) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "splgWTFileSelectByProjectID"
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function lgWTFileSelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal DocPK As Int64) As List(Of SIS.LG.lgWTFile)
      Dim Results As List(Of SIS.LG.lgWTFile) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
      ...
      Return Results
    End Function
    Public Shared Function lgWTFileSelectCount(ByVal SearchState As Boolean, ByVal SearchText As String, ByVal DocPK As Int64) As Integer
      Return _RecordCount
    End Function
      'Select By ID One Record Filtered Overloaded GetByID
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function lgWTFileGetByID(ByVal DocPK As Int64, ByVal FilePK As Int64, ByVal Filter_DocPK As Int64) As SIS.LG.lgWTFile
      Return lgWTFileGetByID(DocPK, FilePK)
    End Function
    <DataObjectMethod(DataObjectMethodType.Update, True)> _
    Public Shared Function lgWTFileUpdate(ByVal Record As SIS.LG.lgWTFile) As SIS.LG.lgWTFile
      Dim _Rec As SIS.LG.lgWTFile = SIS.LG.lgWTFile.lgWTFileGetByID(Record.DocPK, Record.FilePK)
      With _Rec
      ...
      End With
      Return SIS.LG.lgWTFile.UpdateData(_Rec)
    End Function
    Public Shared Function UpdateData(ByVal Record As SIS.LG.lgWTFile) As SIS.LG.lgWTFile
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "splgWTFileUpdate"
    ...
    End Function
'		Autocomplete Method
		Public Shared Function SelectlgWTFileAutoCompleteList(ByVal Prefix As String, ByVal count As Integer, ByVal contextKey As String) As String()
			Dim Results As List(Of String) = Nothing
      Dim aVal() As String = contextKey.Split("|".ToCharArray)
			Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
				Using Cmd As SqlCommand = Con.CreateCommand()
					Cmd.CommandType = CommandType.StoredProcedure
					Cmd.CommandText = "splgWTFileAutoCompleteList"
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@LoginID", SqlDbType.NvarChar, 9, HttpContext.Current.Session("LoginID"))
					...
					End If
					While (Reader.Read())
            Dim Tmp As SIS.LG.lgWTFile = New SIS.LG.lgWTFile(Reader)
