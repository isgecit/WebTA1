...
Namespace SIS.LG
  Partial Public Class lgEPAttributes
		...
		Public Function GetEnable() As Boolean
			...
			Return mRet
		End Function
    Public Shared Function UZ_lgEPAttributesSelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal DocPK As Int64) As List(Of SIS.LG.lgEPAttributes)
      Dim Results As List(Of SIS.LG.lgEPAttributes) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
					If SearchState Then
            Cmd.CommandText = "splg_LG_EPAttributesSelectListSearch"
            Cmd.CommandText = "splgEPAttributesSelectListSearch"
            SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@KeyWord", SqlDbType.NVarChar, 250, SearchText)
					Else
            Cmd.CommandText = "splg_LG_EPAttributesSelectListFilteres"
