...
Namespace SIS.LG
  ...
  Partial Public Class lgEPFile
    ...
    Private _FK_LG_EPFile_DocPK As SIS.LG.lgEPDocument = Nothing
    Private _FK_LG_EPFile_ProjectID As SIS.LG.lgProjects = Nothing
    ...
    Public Class PKlgEPFile
			...
			End Property
    End Class
    Public ReadOnly Property FK_LG_EPFile_DocPK() As SIS.LG.lgEPDocument
      Get
        If _FK_LG_EPFile_DocPK Is Nothing Then
          _FK_LG_EPFile_DocPK = SIS.LG.lgEPDocument.lgEPDocumentGetByID(_DocPK)
        End If
        Return _FK_LG_EPFile_DocPK
      End Get
    End Property
    Public ReadOnly Property FK_LG_EPFile_ProjectID() As SIS.LG.lgProjects
      Get
        If _FK_LG_EPFile_ProjectID Is Nothing Then
          _FK_LG_EPFile_ProjectID = SIS.LG.lgProjects.lgProjectsGetByID(_ProjectID)
        End If
        Return _FK_LG_EPFile_ProjectID
      End Get
    End Property
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function lgEPFileGetNewRecord() As SIS.LG.lgEPFile
      Return New SIS.LG.lgEPFile()
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function lgEPFileGetByID(ByVal DocPK As Int64, ByVal FilePK As Int64) As SIS.LG.lgEPFile
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByDocPK(ByVal DocPK As Int64, ByVal OrderBy as String) As List(Of SIS.LG.lgEPFile)
      Dim Results As List(Of SIS.LG.lgEPFile) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "splgEPFileSelectByDocPK"
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@DocPK",SqlDbType.BigInt,DocPK.ToString.Length, DocPK)
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@LoginID", SqlDbType.NvarChar, 9, HttpContext.Current.Session("LoginID"))
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByProjectID(ByVal ProjectID As String, ByVal OrderBy as String) As List(Of SIS.LG.lgEPFile)
      Dim Results As List(Of SIS.LG.lgEPFile) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "splgEPFileSelectByProjectID"
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function lgEPFileSelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal DocPK As Int64) As List(Of SIS.LG.lgEPFile)
      Dim Results As List(Of SIS.LG.lgEPFile) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
      ...
      Return Results
    End Function
    Public Shared Function lgEPFileSelectCount(ByVal SearchState As Boolean, ByVal SearchText As String, ByVal DocPK As Int64) As Integer
      Return _RecordCount
    End Function
      'Select By ID One Record Filtered Overloaded GetByID
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function lgEPFileGetByID(ByVal DocPK As Int64, ByVal FilePK As Int64, ByVal Filter_DocPK As Int64) As SIS.LG.lgEPFile
      Return lgEPFileGetByID(DocPK, FilePK)
    End Function
    <DataObjectMethod(DataObjectMethodType.Update, True)> _
    Public Shared Function lgEPFileUpdate(ByVal Record As SIS.LG.lgEPFile) As SIS.LG.lgEPFile
      Dim _Rec As SIS.LG.lgEPFile = SIS.LG.lgEPFile.lgEPFileGetByID(Record.DocPK, Record.FilePK)
      With _Rec
      ...
      End With
      Return SIS.LG.lgEPFile.UpdateData(_Rec)
    End Function
    Public Shared Function UpdateData(ByVal Record As SIS.LG.lgEPFile) As SIS.LG.lgEPFile
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "splgEPFileUpdate"
