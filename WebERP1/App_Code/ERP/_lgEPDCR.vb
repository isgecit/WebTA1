...
Namespace SIS.LG
  ...
  Partial Public Class lgEPDCR
    ...
    Private _FK_LG_EPDCR_DocPK As SIS.LG.lgEPDocument = Nothing
    Private _FK_LG_EPDCR_ProjectID As SIS.LG.lgProjects = Nothing
    ...
    Public Class PKlgEPDCR
			...
			End Property
    End Class
    Public ReadOnly Property FK_LG_EPDCR_DocPK() As SIS.LG.lgEPDocument
      Get
        If _FK_LG_EPDCR_DocPK Is Nothing Then
          _FK_LG_EPDCR_DocPK = SIS.LG.lgEPDocument.lgEPDocumentGetByID(_DocPK)
        End If
        Return _FK_LG_EPDCR_DocPK
      End Get
    End Property
    Public ReadOnly Property FK_LG_EPDCR_ProjectID() As SIS.LG.lgProjects
      Get
        If _FK_LG_EPDCR_ProjectID Is Nothing Then
          _FK_LG_EPDCR_ProjectID = SIS.LG.lgProjects.lgProjectsGetByID(_ProjectID)
        End If
        Return _FK_LG_EPDCR_ProjectID
      End Get
    End Property
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function lgEPDCRSelectList(ByVal OrderBy As String) As List(Of SIS.LG.lgEPDCR)
      Dim Results As List(Of SIS.LG.lgEPDCR) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "splgEPDCRSelectList"
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function lgEPDCRGetNewRecord() As SIS.LG.lgEPDCR
      Return New SIS.LG.lgEPDCR()
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function lgEPDCRGetByID(ByVal DocPK As Int64, ByVal DCRID As String, ByVal DCRLine As Int32) As SIS.LG.lgEPDCR
      Dim Results As SIS.LG.lgEPDCR = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "splgEPDCRSelectByID"
          ...
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
					If Reader.Read() Then
						Results = New SIS.LG.lgEPDCR(Reader)
					End If
					Reader.Close()
        End Using
      End Using
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByDocPK(ByVal DocPK As Int64, ByVal OrderBy as String) As List(Of SIS.LG.lgEPDCR)
      Dim Results As List(Of SIS.LG.lgEPDCR) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "splgEPDCRSelectByDocPK"
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@DocPK",SqlDbType.BigInt,DocPK.ToString.Length, DocPK)
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@LoginID", SqlDbType.NvarChar, 9, HttpContext.Current.Session("LoginID"))
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@OrderBy", SqlDbType.NVarChar, 50, OrderBy)
          Cmd.Parameters.Add("@RecordCount", SqlDbType.Int)
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByProjectID(ByVal ProjectID As String, ByVal OrderBy as String) As List(Of SIS.LG.lgEPDCR)
      Dim Results As List(Of SIS.LG.lgEPDCR) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "splgEPDCRSelectByProjectID"
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function lgEPDCRSelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal DocPK As Int64) As List(Of SIS.LG.lgEPDCR)
      Dim Results As List(Of SIS.LG.lgEPDCR) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
      ...
      Return Results
    End Function
    Public Shared Function lgEPDCRSelectCount(ByVal SearchState As Boolean, ByVal SearchText As String, ByVal DocPK As Int64) As Integer
      Return _RecordCount
    End Function
      'Select By ID One Record Filtered Overloaded GetByID
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function lgEPDCRGetByID(ByVal DocPK As Int64, ByVal DCRID As String, ByVal DCRLine As Int32, ByVal Filter_DocPK As Int64) As SIS.LG.lgEPDCR
      Return lgEPDCRGetByID(DocPK, DCRID, DCRLine)
    End Function
'		Autocomplete Method
		Public Shared Function SelectlgEPDCRAutoCompleteList(ByVal Prefix As String, ByVal count As Integer, ByVal contextKey As String) As String()
			Dim Results As List(Of String) = Nothing
      Dim aVal() As String = contextKey.Split("|".ToCharArray)
			Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
				Using Cmd As SqlCommand = Con.CreateCommand()
					Cmd.CommandType = CommandType.StoredProcedure
					Cmd.CommandText = "splgEPDCRAutoCompleteList"
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@LoginID", SqlDbType.NvarChar, 9, HttpContext.Current.Session("LoginID"))
					...
					End If
					While (Reader.Read())
            Dim Tmp As SIS.LG.lgEPDCR = New SIS.LG.lgEPDCR(Reader)
