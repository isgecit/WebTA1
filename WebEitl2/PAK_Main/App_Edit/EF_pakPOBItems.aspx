<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_pakPOBItems.aspx.vb" Inherits="EF_pakPOBItems" title="Edit: PO Item Details" %>
<asp:Content ID="CPHpakPOBItems" ContentPlaceHolderID="cph1" runat="Server">
  <div id="div1" class="ui-widget-content page">
    <div id="div2" class="caption">
      <asp:Label ID="LabelpakPOBItems" runat="server" Text="&nbsp;Edit: PO Item Details"></asp:Label>
    </div>
    <div id="div3" class="pagedata">
              ...
              <div id="frmdiv" class="ui-widget-content minipage">
                <table style="margin: auto; border: solid 1pt lightgrey">
                  <tr>
                    ...
                    <td class="alignright">
                      <b>
                        <asp:Label ID="L_BOMNo" runat="server" ForeColor="#CC6633" Text="BOM No :" /><span style="color: red">*</span></b>
                    </td>
                    <td>
                      <asp:TextBox
                        ID="F_BOMNo"
                  ...
                  <%--      <tr>
                    ...
                    <td>
                      ...
                      <asp:Label
                        ...
                        Text='<%# Eval("PAK_POBOMStatus9_Description") %>'
                        CssClass="myLbl"
                        Runat="Server" />
                    </td>
                  </tr>--%>
      ...
      <asp:ObjectDataSource
        ...
        UpdateMethod="UZ_pakPOBItemsUpdate"
        OldValuesParameterFormatString="original_{0}"
