<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_pakPkgPortH.aspx.vb" Inherits="EF_pakPkgPortH" title="Edit: Port Packing List" %>
<asp:Content ID="CPHpakPkgListH" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelpakPkgListH" runat="server" Text="&nbsp;Edit: Port Packing List"></asp:Label>
</div>
...
<legend>
    <asp:Label ID="LabelpakPkgListD" runat="server" Text="&nbsp;List: Port Packing List Items"></asp:Label>
</legend>
<div class="pagedata">
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "pakPkgPortHGetByID"
