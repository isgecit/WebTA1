<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_pakTCPO.aspx.vb" Inherits="EF_pakTCPO" title="Edit: Issue PO" %>
<asp:Content ID="CPHpakTCPO" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelpakTCPO" runat="server" Text="&nbsp;Edit: Issue PO"></asp:Label>
</div>
...
<ContentTemplate>
  <LGM:ToolBar0 
    ...
    EnableDelete = "False"
    EnablePrint = "True"
    PrintUrl = "../App_Print/RP_pakTCPO.aspx?pk="
...
<asp:FormView ID="FVpakTCPO"
  runat = "server"
  DataKeyNames = "SerialNo"
  DataSourceID = "ODSpakTCPO"
...
<legend>
    <asp:Label ID="LabelpakTCPOL" runat="server" Text="&nbsp;List: PO Items"></asp:Label>
</legend>
<div class="pagedata">
<asp:UpdatePanel ID="UPNLpakTCPOL" runat="server">
  <ContentTemplate>
    ...
    <LGM:ToolBar0 
      ID = "TBLpakTCPOL"
      ToolType = "lgNMGrid"
      EditUrl = "~/PAK_Main/App_Edit/EF_pakTCPOL.aspx"
      EnableAdd = "False"
      EnableExit = "false"
      ValidationGroup = "pakTCPOL"
      runat = "server" />
    <asp:UpdateProgress ID="UPGSpakTCPOL" runat="server" AssociatedUpdatePanelID="UPNLpakTCPOL" DisplayAfter="100">
      <ProgressTemplate>
        <span style="color: #ff0033">Loading...</span>
      </ProgressTemplate>
    </asp:UpdateProgress>
    <asp:GridView ID="GVpakTCPOL" SkinID="gv_silver" runat="server" DataSourceID="ODSpakTCPOL" DataKeyNames="SerialNo,ItemNo">
      <Columns>
    ...
    <asp:ObjectDataSource 
      ...
      SelectCountMethod = "pakTCPOLSelectCount"
  ...
  <Triggers>
    <asp:AsyncPostBackTrigger ControlID="GVpakTCPOL" EventName="PageIndexChanged" />
  </Triggers>
</asp:UpdatePanel>
</div>
</fieldset>
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "pakTCPOGetByID"
  UpdateMethod="UZ_pakTCPOUpdate"
  OldValuesParameterFormatString = "original_{0}"
