<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_pakPOBOM.aspx.vb" Inherits="EF_pakPOBOM" title="Edit: PO Item" %>
<asp:Content ID="CPHpakPOBOM" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelpakPOBOM" runat="server" Text="&nbsp;Edit: PO Item"></asp:Label>
</div>
...
<legend>
    <asp:Label ID="LabelpakPOBItems" runat="server" Text="&nbsp;List: PO Item Details"></asp:Label>
</legend>
<div class="pagedata">
<asp:UpdatePanel ID="UPNLpakPOBItems" runat="server">
  <ContentTemplate>
    ...
    <LGM:ToolBar0 
      ID = "TBLpakPOBItems"
      ToolType = "lgNMGrid"
      EditUrl = "~/PAK_Main/App_Edit/EF_pakPOBItems.aspx"
      EnableAdd = "False"
      EnableExit = "false"
