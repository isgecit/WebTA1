<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="False" CodeFile="GF_pakSTCPO.aspx.vb" Inherits="GF_pakSTCPO" title="Maintain List: PO" %>
<asp:Content ID="CPHpakSTCPO" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabelpakSTCPO" runat="server" Text="&nbsp;List: PO"></asp:Label>
</div>
<div class="pagedata">
<asp:UpdatePanel ID="UPNLpakSTCPO" runat="server">
  <ContentTemplate>
    ...
    <LGM:ToolBar0 
      ID = "TBLpakSTCPO"
      ToolType = "lgNMGrid"
      EditUrl = "~/PAK_Main/App_Edit/EF_pakSTCPO.aspx"
      EnableAdd = "False"
      ValidationGroup = "pakSTCPO"
      runat = "server" />
    <asp:UpdateProgress ID="UPGSpakSTCPO" runat="server" AssociatedUpdatePanelID="UPNLpakSTCPO" DisplayAfter="100">
      <ProgressTemplate>
    ...
    <asp:GridView ID="GVpakSTCPO" SkinID="gv_silver" runat="server" DataSourceID="ODSpakSTCPO" DataKeyNames="SerialNo">
      <Columns>
...
<%--        <asp:TemplateField HeaderText="CLOSE">
    ...
    <asp:ObjectDataSource 
      ...
      SelectMethod = "UZ_pakSTCPOSelectList"
      TypeName = "SIS.PAK.pakSTCPO"
      SelectCountMethod = "pakSTCPOSelectCount"
  ...
  <Triggers>
    <asp:AsyncPostBackTrigger ControlID="GVpakSTCPO" EventName="PageIndexChanged" />
