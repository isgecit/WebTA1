...
Partial Class GF_pakSTCPOL
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/PAK_Main/App_Display/DF_pakSTCPOL.aspx"
  Protected Sub Info_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
    Dim oBut As ImageButton = CType(sender, ImageButton)
    Dim aVal() As String = oBut.CommandArgument.ToString.Split(",".ToCharArray)
    Dim RedirectUrl As String = _InfoUrl  & "?SerialNo=" & aVal(0) & "&ItemNo=" & aVal(1)
  ...
  Protected Sub GVpakSTCPOL_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVpakSTCPOL.Init
    DataClassName = "GpakSTCPOL"
    SetGridView = GVpakSTCPOL
  End Sub
  ...
  Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    Dim validateScriptSerialNo As String = "<script type=""text/javascript"">" & _
      ...
      "    validated_FK_PAK_POLine_SerialNo_main = true;" & _
      "    validate_FK_PAK_POLine_SerialNo(o);" & _
      "  }" & _
      "</script>"
    ...
    End If
    Dim validateScriptFK_PAK_POLine_SerialNo As String = "<script type=""text/javascript"">" & _
      "  function validate_FK_PAK_POLine_SerialNo(o) {" & _
      "    var value = o.id;" & _
      "    var SerialNo = $get('" & F_SerialNo.ClientID & "');" & _
      "    try{" & _
      "    if(SerialNo.value==''){" & _
      "      if(validated_FK_PAK_POLine_SerialNo.main){" & _
      ...
      "    PageMethods.validate_FK_PAK_POLine_SerialNo(value, validated_FK_PAK_POLine_SerialNo);" & _
      "  }" & _
      "  validated_FK_PAK_POLine_SerialNo_main = false;" & _
      "  function validated_FK_PAK_POLine_SerialNo(result) {" & _
      ...
      "  }" & _
      "</script>"
    If Not Page.ClientScript.IsClientScriptBlockRegistered("validateFK_PAK_POLine_SerialNo") Then
      Page.ClientScript.RegisterClientScriptBlock(GetType(System.String), "validateFK_PAK_POLine_SerialNo", validateScriptFK_PAK_POLine_SerialNo)
    End If
  End Sub
  <System.Web.Services.WebMethod()> _
  Public Shared Function validate_FK_PAK_POLine_SerialNo(ByVal value As String) As String
