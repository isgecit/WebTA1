<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="False" CodeFile="GF_pakHPendingAtPort.aspx.vb" Inherits="GF_pakHPendingAtPort" title="List: Pending To Receive At Port" %>
<asp:Content ID="CPHpakHPending" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabelpakHPending" runat="server" Text="&nbsp;List: Pending To Receive At Port"></asp:Label>
</div>
<div class="pagedata">
<asp:UpdatePanel ID="UPNLpakHPending" runat="server">
  <ContentTemplate>
    ...
    <asp:ObjectDataSource 
      ...
      SelectMethod = "UZ_pakHPendingAtPortSelectList"
