<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="False" CodeFile="GF_pakSTCPOLRD.aspx.vb" Inherits="GF_pakSTCPOLRD" title="Maintain List: Documents" %>
<asp:Content ID="CPHpakSTCPOLRD" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabelpakSTCPOLRD" runat="server" Text="&nbsp;List: Documents"></asp:Label>
</div>
<div class="pagedata">
