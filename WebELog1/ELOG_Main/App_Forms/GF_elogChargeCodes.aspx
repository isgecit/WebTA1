<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="False" CodeFile="GF_elogChargeCodes.aspx.vb" Inherits="GF_elogChargeCodes" title="Maintain List: ELOG_ChargeCodes" %>
...
<asp:UpdatePanel ID="UPNLelogChargeCodes" runat="server">
  <ContentTemplate>
    ...
    <table>
      <tr>
        <td class="alignright">
          <b><asp:Label ID="L_ChargeCategoryID" runat="server" Text="Charge Category ID :" /></b>
        </td>
        <td>
          <LGM:LC_elogChargeCategories
            ...
            DataValueField="ChargeCategoryID"
            IncludeDefault="true"
            DefaultText="-- Select --"
            Width="200px"
            AutoPostBack="true"
    ...
    <asp:ObjectDataSource 
      ...
      <SelectParameters >
        <asp:ControlParameter ControlID="F_ChargeCategoryID" PropertyName="SelectedValue" Name="ChargeCategoryID" Type="Int32" Size="10" />
  ...
  <Triggers>
    ...
    <asp:AsyncPostBackTrigger ControlID="F_ChargeCategoryID" />
  </Triggers>
</asp:UpdatePanel>
</div>
</div>
