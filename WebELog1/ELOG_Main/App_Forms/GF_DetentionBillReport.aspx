<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_DetentionBillReport.aspx.vb" Inherits="GF_DetentionBillReport" title="Detention Bill Report" %>
<asp:Content ID="CPHlgDMisg" ContentPlaceHolderID="cph1" Runat="Server">
  <div id="div1" class="page">
<asp:UpdatePanel ID="UPNLlgDMisg" runat="server">
  <ContentTemplate>
    <h1><font color="Blue">Detention Bill Report</font></h1>
    ...
    <script type="text/javascript">
      ...
      function print_report(o) {
       ...
       function script_download(typ) {
       	pcnt = pcnt + 1;
       	var nam = 'wdwd' + pcnt;
       	var url = self.location.href.replace('App_Forms/GF_DetentionBillReport.aspx', 'App_Downloads/DetentionBillReport.aspx');
