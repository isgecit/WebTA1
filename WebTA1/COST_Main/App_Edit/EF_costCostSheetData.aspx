<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_costCostSheetData.aspx.vb" Inherits="EF_costCostSheetData" title="Edit: Cost Sheet Data" %>
<asp:Content ID="CPHcostCostSheetData" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelcostCostSheetData" runat="server" Text="&nbsp;Edit: Cost Sheet Data"></asp:Label>
</div>
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "costCostSheetDataGetByID"
  UpdateMethod="UZ_costCostSheetDataUpdate"
