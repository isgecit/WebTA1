...
var script_costAdjustmentEntry = {
    ...
    validate_FinYear: function(sender) {
      ...
      this.validated_FK_COST_AdjustmentEntry_FinYear_main = true;
      this.validate_FK_COST_AdjustmentEntry_FinYear(sender,Prefix);
      },
    validate_ProjectGroupID: function(sender) {
      var Prefix = sender.id.replace('ProjectGroupID','');
      this.validated_FK_COST_AdjustmentEntry_ProjectGroupID_main = true;
      this.validate_FK_COST_AdjustmentEntry_ProjectGroupID(sender,Prefix);
      },
    validate_Revision: function(sender) {
      var Prefix = sender.id.replace('Revision','');
      },
    validate_Quarter: function(sender) {
      var Prefix = sender.id.replace('Quarter','');
      this.validated_FK_COST_AdjustmentEntry_Quarter_main = true;
      this.validate_FK_COST_AdjustmentEntry_Quarter(sender,Prefix);
      },
    ...
    validate_FK_COST_AdjustmentEntry_FinYear: function(o,Prefix) {
      var value = o.id;
      var FinYear = $get(Prefix + 'FinYear');
      if(FinYear.value==''){
        if(this.validated_FK_COST_AdjustmentEntry_FinYear_main){
      ...
      value = value + ',' + FinYear.value ;
        ...
        o.style.backgroundRepeat= 'no-repeat';
        o.style.backgroundPosition = 'right';
        PageMethods.validate_FK_COST_AdjustmentEntry_FinYear(value, this.validated_FK_COST_AdjustmentEntry_FinYear);
      },
    validated_FK_COST_AdjustmentEntry_FinYear_main: false,
    validated_FK_COST_AdjustmentEntry_FinYear: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_costAdjustmentEntry.validated_FK_COST_AdjustmentEntry_FinYear_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validate_FK_COST_AdjustmentEntry_ProjectGroupID: function(o,Prefix) {
      var value = o.id;
      var ProjectGroupID = $get(Prefix + 'ProjectGroupID');
      if(ProjectGroupID.value==''){
        if(this.validated_FK_COST_AdjustmentEntry_ProjectGroupID_main){
      ...
      value = value + ',' + ProjectGroupID.value ;
        ...
        o.style.backgroundRepeat= 'no-repeat';
        o.style.backgroundPosition = 'right';
        PageMethods.validate_FK_COST_AdjustmentEntry_ProjectGroupID(value, this.validated_FK_COST_AdjustmentEntry_ProjectGroupID);
      },
    validated_FK_COST_AdjustmentEntry_ProjectGroupID_main: false,
    validated_FK_COST_AdjustmentEntry_ProjectGroupID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_costAdjustmentEntry.validated_FK_COST_AdjustmentEntry_ProjectGroupID_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validate_FK_COST_AdjustmentEntry_Quarter: function(o,Prefix) {
      var value = o.id;
      var Quarter = $get(Prefix + 'Quarter');
      if(Quarter.value==''){
        if(this.validated_FK_COST_AdjustmentEntry_Quarter_main){
      ...
      value = value + ',' + Quarter.value ;
        ...
        o.style.backgroundRepeat= 'no-repeat';
        o.style.backgroundPosition = 'right';
        PageMethods.validate_FK_COST_AdjustmentEntry_Quarter(value, this.validated_FK_COST_AdjustmentEntry_Quarter);
      },
    validated_FK_COST_AdjustmentEntry_Quarter_main: false,
    validated_FK_COST_AdjustmentEntry_Quarter: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_costAdjustmentEntry.validated_FK_COST_AdjustmentEntry_Quarter_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
