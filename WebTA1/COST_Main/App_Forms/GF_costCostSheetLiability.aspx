<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="False" CodeFile="GF_costCostSheetLiability.aspx.vb" Inherits="GF_costCostSheetLiability" title="Maintain List: Cost Sheet Liability" %>
<asp:Content ID="CPHcostCostSheetLiability" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabelcostCostSheetLiability" runat="server" Text="&nbsp;List: Cost Sheet Liability"></asp:Label>
</div>
<div class="pagedata">
<asp:UpdatePanel ID="UPNLcostCostSheetLiability" runat="server">
  <ContentTemplate>
    ...
    <LGM:ToolBar0 
      ...
      ToolType = "lgNMGrid"
      EditUrl = "~/COST_Main/App_Edit/EF_costCostSheetLiability.aspx"
      EnableAdd = "False"
      ValidationGroup = "costCostSheetLiability"
      runat = "server" />
    <asp:UpdateProgress ID="UPGScostCostSheetLiability" runat="server" AssociatedUpdatePanelID="UPNLcostCostSheetLiability" DisplayAfter="100">
      <ProgressTemplate>
    ...
    <asp:GridView ID="GVcostCostSheetLiability" SkinID="gv_silver" runat="server" DataSourceID="ODScostCostSheetLiability" DataKeyNames="ProjectGroupID,FinYear,Quarter,Revision,ProjectID,GLCode,AdjustmentSerialNo,AdjustmentCredit">
      <Columns>
    ...
    <asp:ObjectDataSource 
      ...
      SelectMethod = "UZ_costCostSheetLiabilitySelectList"
      TypeName = "SIS.COST.costCostSheetLiability"
      SelectCountMethod = "costCostSheetLiabilitySelectCount"
  ...
  <Triggers>
    <asp:AsyncPostBackTrigger ControlID="GVcostCostSheetLiability" EventName="PageIndexChanged" />
