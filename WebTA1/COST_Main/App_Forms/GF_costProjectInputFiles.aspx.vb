Partial Class GF_costProjectInputFiles
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/COST_Main/App_Display/DF_costProjectInputFiles.aspx"
  Protected Sub Info_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
    Dim oBut As ImageButton = CType(sender, ImageButton)
    Dim aVal() As String = oBut.CommandArgument.ToString.Split(",".ToCharArray)
    Dim RedirectUrl As String = _InfoUrl  & "?ProjectGroupID=" & aVal(0) & "&FinYear=" & aVal(1) & "&Quarter=" & aVal(2) & "&SerialNo=" & aVal(3)
  ...
  Protected Sub GVcostProjectInputFiles_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVcostProjectInputFiles.Init
    DataClassName = "GcostProjectInputFiles"
    SetGridView = GVcostProjectInputFiles
  End Sub
  ...
  Public Shared Function QuarterCompletionList(ByVal prefixText As String, ByVal count As Integer, ByVal contextKey As String) As String()
    Return SIS.COST.costProjectsInput.SelectcostProjectsInputAutoCompleteList(prefixText, count, contextKey)
  End Function
  Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    Dim validateScriptProjectGroupID As String = "<script type=""text/javascript"">" & _
      ...
      "    validated_FK_COST_ProjectInputFiles_ProjectGroupID_main = true;" & _
      "    validate_FK_COST_ProjectInputFiles_ProjectGroupID(o);" & _
      "  }" & _
      "</script>"
    ...
    Dim validateScriptFinYear As String = "<script type=""text/javascript"">" & _
      ...
      "    validated_FK_COST_ProjectInputFiles_FinYear_main = true;" & _
      "    validate_FK_COST_ProjectInputFiles_FinYear(o);" & _
      "  }" & _
      "</script>"
    ...
    Dim validateScriptQuarter As String = "<script type=""text/javascript"">" & _
      ...
      "    validated_FK_COST_ProjectInputFiles_ProjectInput_main = true;" & _
      "    validate_FK_COST_ProjectInputFiles_ProjectInput(o);" & _
      "  }" & _
      "</script>"
    ...
    End If
    Dim validateScriptFK_COST_ProjectInputFiles_FinYear As String = "<script type=""text/javascript"">" & _
      "  function validate_FK_COST_ProjectInputFiles_FinYear(o) {" & _
      "    var value = o.id;" & _
      "    var FinYear = $get('" & F_FinYear.ClientID & "');" & _
      "    try{" & _
      "    if(FinYear.value==''){" & _
      "      if(validated_FK_COST_ProjectInputFiles_FinYear.main){" & _
      ...
      "    PageMethods.validate_FK_COST_ProjectInputFiles_FinYear(value, validated_FK_COST_ProjectInputFiles_FinYear);" & _
      "  }" & _
      "  validated_FK_COST_ProjectInputFiles_FinYear_main = false;" & _
      "  function validated_FK_COST_ProjectInputFiles_FinYear(result) {" & _
      ...
      "  }" & _
      "</script>"
    If Not Page.ClientScript.IsClientScriptBlockRegistered("validateFK_COST_ProjectInputFiles_FinYear") Then
      Page.ClientScript.RegisterClientScriptBlock(GetType(System.String), "validateFK_COST_ProjectInputFiles_FinYear", validateScriptFK_COST_ProjectInputFiles_FinYear)
    End If
    Dim validateScriptFK_COST_ProjectInputFiles_ProjectGroupID As String = "<script type=""text/javascript"">" & _
      "  function validate_FK_COST_ProjectInputFiles_ProjectGroupID(o) {" & _
      "    var value = o.id;" & _
      "    var ProjectGroupID = $get('" & F_ProjectGroupID.ClientID & "');" & _
      "    try{" & _
      "    if(ProjectGroupID.value==''){" & _
      "      if(validated_FK_COST_ProjectInputFiles_ProjectGroupID.main){" & _
      "        var o_d = $get(o.id +'_Display');" & _
      "        try{o_d.innerHTML = '';}catch(ex){}" & _
      "      }" & _
      "    }" & _
      ...
      "    o.style.backgroundRepeat= 'no-repeat';" & _
      "    o.style.backgroundPosition = 'right';" & _
      "    PageMethods.validate_FK_COST_ProjectInputFiles_ProjectGroupID(value, validated_FK_COST_ProjectInputFiles_ProjectGroupID);" & _
      "  }" & _
      "  validated_FK_COST_ProjectInputFiles_ProjectGroupID_main = false;" & _
      "  function validated_FK_COST_ProjectInputFiles_ProjectGroupID(result) {" & _
      "    var p = result.split('|');" & _
      "    var o = $get(p[1]);" & _
      "    var o_d = $get(p[1]+'_Display');" & _
      "    try{o_d.innerHTML = p[2];}catch(ex){}" & _
      ...
      "  }" & _
      "</script>"
    If Not Page.ClientScript.IsClientScriptBlockRegistered("validateFK_COST_ProjectInputFiles_ProjectGroupID") Then
      Page.ClientScript.RegisterClientScriptBlock(GetType(System.String), "validateFK_COST_ProjectInputFiles_ProjectGroupID", validateScriptFK_COST_ProjectInputFiles_ProjectGroupID)
    End If
    Dim validateScriptFK_COST_ProjectInputFiles_ProjectInput As String = "<script type=""text/javascript"">" & _
      "  function validate_FK_COST_ProjectInputFiles_ProjectInput(o) {" & _
      "    var value = o.id;" & _
      "    var ProjectGroupID = $get('" & F_ProjectGroupID.ClientID & "');" & _
      "    try{" & _
      "    if(ProjectGroupID.value==''){" & _
      "      if(validated_FK_COST_ProjectInputFiles_ProjectInput.main){" & _
      "        var o_d = $get(o.id +'_Display');" & _
      "        try{o_d.innerHTML = '';}catch(ex){}" & _
      "      }" & _
      "    }" & _
      ...
      "    o.style.backgroundRepeat= 'no-repeat';" & _
      "    o.style.backgroundPosition = 'right';" & _
      "    PageMethods.validate_FK_COST_ProjectInputFiles_ProjectInput(value, validated_FK_COST_ProjectInputFiles_ProjectInput);" & _
      "  }" & _
      "  validated_FK_COST_ProjectInputFiles_ProjectInput_main = false;" & _
      "  function validated_FK_COST_ProjectInputFiles_ProjectInput(result) {" & _
      "    var p = result.split('|');" & _
      "    var o = $get(p[1]);" & _
      "    var o_d = $get(p[1]+'_Display');" & _
      "    try{o_d.innerHTML = p[2];}catch(ex){}" & _
      ...
      "  }" & _
      "</script>"
    If Not Page.ClientScript.IsClientScriptBlockRegistered("validateFK_COST_ProjectInputFiles_ProjectInput") Then
      Page.ClientScript.RegisterClientScriptBlock(GetType(System.String), "validateFK_COST_ProjectInputFiles_ProjectInput", validateScriptFK_COST_ProjectInputFiles_ProjectInput)
    End If
  End Sub
  <System.Web.Services.WebMethod()> _
  Public Shared Function validate_FK_COST_ProjectInputFiles_FinYear(ByVal value As String) As String
  ...
  End Function
  <System.Web.Services.WebMethod()> _
  Public Shared Function validate_FK_COST_ProjectInputFiles_ProjectGroupID(ByVal value As String) As String
    Dim aVal() As String = value.Split(",".ToCharArray)
    Dim mRet As String="0|" & aVal(0)
  ...
  End Function
  <System.Web.Services.WebMethod()> _
  Public Shared Function validate_FK_COST_ProjectInputFiles_ProjectInput(ByVal value As String) As String
    Dim aVal() As String = value.Split(",".ToCharArray)
    Dim mRet As String="0|" & aVal(0)
    Dim ProjectGroupID As Int32 = CType(aVal(1),Int32)
    Dim FinYear As Int32 = CType(aVal(2),Int32)
    Dim Quarter As Int32 = CType(aVal(3),Int32)
