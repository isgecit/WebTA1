Partial Class GF_costProjectsInputAC
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/COST_Main/App_Display/DF_costProjectsInputAC.aspx"
  ...
  Protected Sub GVcostProjectsInputAC_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVcostProjectsInputAC.Init
    DataClassName = "GcostProjectsInputAC"
    SetGridView = GVcostProjectsInputAC
  End Sub
