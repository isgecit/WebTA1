Partial Class GF_costProjectsInput
  ...
  End Sub
  Protected Sub GVcostProjectsInput_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GVcostProjectsInput.RowCommand
    If e.CommandName.ToLower = "lgedit".ToLower Then
      Try
        Dim ProjectGroupID As Int32 = GVcostProjectsInput.DataKeys(e.CommandArgument).Values("ProjectGroupID")  
        Dim FinYear As Int32 = GVcostProjectsInput.DataKeys(e.CommandArgument).Values("FinYear")  
        Dim Quarter As Int32 = GVcostProjectsInput.DataKeys(e.CommandArgument).Values("Quarter")  
        Dim RedirectUrl As String = TBLcostProjectsInput.EditUrl & "?ProjectGroupID=" & ProjectGroupID & "&FinYear=" & FinYear & "&Quarter=" & Quarter
        Response.Redirect(RedirectUrl)
    ...
    If e.CommandName.ToLower = "initiatewf".ToLower Then
      Try
        ...
        Dim FinYear As Int32 = GVcostProjectsInput.DataKeys(e.CommandArgument).Values("FinYear")  
        Dim Quarter As Int32 = GVcostProjectsInput.DataKeys(e.CommandArgument).Values("Quarter")  
        SIS.COST.costProjectsInput.InitiateWF(ProjectGroupID, FinYear, Quarter)
        GVcostProjectsInput.DataBind()
      Catch ex As Exception
      End Try
    End If
  End Sub
  Protected Sub GVcostProjectsInput_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVcostProjectsInput.Init
    DataClassName = "GcostProjectsInput"
    SetGridView = GVcostProjectsInput
  End Sub
