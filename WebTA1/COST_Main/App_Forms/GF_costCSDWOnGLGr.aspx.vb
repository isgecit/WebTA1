Partial Class GF_costCSDWOnGLGr
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/COST_Main/App_Display/DF_costCSDWOnGLGr.aspx"
  ...
  Protected Sub GVcostCSDWOnGLGr_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVcostCSDWOnGLGr.Init
    DataClassName = "GcostCSDWOnGLGr"
    SetGridView = GVcostCSDWOnGLGr
  End Sub
