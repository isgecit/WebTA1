<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_costProjectsInput.aspx.vb" Inherits="GF_costProjectsInput" title="Maintain List: Projects Input" %>
<asp:Content ID="CPHcostProjectsInput" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabelcostProjectsInput" runat="server" Text="&nbsp;List: Projects Input"></asp:Label>
</div>
<div class="pagedata">
<asp:UpdatePanel ID="UPNLcostProjectsInput" runat="server">
  <ContentTemplate>
    ...
    <LGM:ToolBar0 
      ...
      ToolType = "lgNMGrid"
      EditUrl = "~/COST_Main/App_Edit/EF_costProjectsInput.aspx"
      AddUrl = "~/COST_Main/App_Create/AF_costProjectsInput.aspx?skip=1"
      ValidationGroup = "costProjectsInput"
      runat = "server" />
    <asp:UpdateProgress ID="UPGScostProjectsInput" runat="server" AssociatedUpdatePanelID="UPNLcostProjectsInput" DisplayAfter="100">
      <ProgressTemplate>
    ...
    <asp:GridView ID="GVcostProjectsInput" SkinID="gv_silver" runat="server" DataSourceID="ODScostProjectsInput" DataKeyNames="ProjectGroupID,FinYear,Quarter">
      <Columns>
        ...
        <asp:TemplateField HeaderText="Status ID" SortExpression="COST_ProjectInputStatus5_Description">
          <ItemTemplate>
             <asp:Label ID="L_StatusID" runat="server" ForeColor='<%# EVal("ForeColor") %>' Title='<%# EVal("StatusID") %>' Text='<%# Eval("COST_ProjectInputStatus5_Description") %>'></asp:Label>
          </ItemTemplate>
          <HeaderStyle Width="100px" />
        </asp:TemplateField>
    ...
    <asp:ObjectDataSource 
      ...
      SelectMethod = "UZ_costProjectsInputSelectList"
      TypeName = "SIS.COST.costProjectsInput"
      SelectCountMethod = "costProjectsInputSelectCount"
  ...
  <Triggers>
    <asp:AsyncPostBackTrigger ControlID="GVcostProjectsInput" EventName="PageIndexChanged" />
