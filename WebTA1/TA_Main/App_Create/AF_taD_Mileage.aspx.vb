Partial Class AF_taD_Mileage
  ...
  End Sub
  Protected Sub FVtaD_Mileage_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles FVtaD_Mileage.DataBound
    SIS.TA.taD_Mileage.SetDefaultValues(sender, e) 
  End Sub
  Protected Sub FVtaD_Mileage_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles FVtaD_Mileage.PreRender
    Dim oF_CategoryID As LC_taCategories = FVtaD_Mileage.FindControl("F_CategoryID")
    ...
    If Not Session("F_CategoryID") Is Nothing Then
      ...
      End If
    End If
    Dim oF_CityID_Display As Label  = FVtaD_Mileage.FindControl("F_CityID_Display")
    ...
    If Not Session("F_CityID_Display") Is Nothing Then
      ...
      End If
    End If
    Dim oF_CityID As TextBox  = FVtaD_Mileage.FindControl("F_CityID")
    ...
    End If
    Dim mStr As String = ""
    Dim oTR As IO.StreamReader = New IO.StreamReader(HttpContext.Current.Server.MapPath("~/TA_Main/App_Create") & "/AF_taD_Mileage.js")
    mStr = oTR.ReadToEnd
    oTR.Close()
    oTR.Dispose()
    ...
    If Request.QueryString("SerialNo") IsNot Nothing Then
      CType(FVtaD_Mileage.FindControl("F_SerialNo"), TextBox).Text = Request.QueryString("SerialNo")
      CType(FVtaD_Mileage.FindControl("F_SerialNo"), TextBox).Enabled = False
    End If
  End Sub
