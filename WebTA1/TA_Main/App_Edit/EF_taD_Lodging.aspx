<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_taD_Lodging.aspx.vb" Inherits="EF_taD_Lodging" title="Edit: Category-City Type Wise Hotel Charges" %>
<asp:Content ID="CPHtaD_Lodging" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabeltaD_Lodging" runat="server" Text="&nbsp;Edit: Category-City Type Wise Hotel Charges"></asp:Label>
</div>
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "taD_LodgingGetByID"
  UpdateMethod="taD_LodgingUpdate"
  DeleteMethod="taD_LodgingDelete"
