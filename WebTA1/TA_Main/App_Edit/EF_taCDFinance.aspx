<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_taCDFinance.aspx.vb" Inherits="EF_taCDFinance" title="Edit: Source of Finance" %>
<asp:Content ID="CPHtaCDFinance" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabeltaCDFinance" runat="server" Text="&nbsp;Edit: Source of Finance"></asp:Label>
</div>
  ...
  <EditItemTemplate>
    ...
    <table style="margin:auto;border: solid 1pt lightgrey">
      ...
      <tr>
        ...
        <td class="alignright">
          <asp:Label ID="L_ModeText" runat="server" Text="Other Finance Source :" />&nbsp;
        </td>
        <td>
...
<%--      <tr>
      ...
      <tr><td colspan="4" style="border-top: solid 1pt LightGrey" ></td></tr>
      <tr id="taCDFinance_0"><td colspan="4" onclick="groupClicked(this);" class="groupHeader" >Accounts Section</td></tr>
      <tr>
        <td class="alignright">
      ...
      <tr>
        ...
        <td>
          <asp:TextBox
            ...
            onblur= "script_taCDFinance.validate_ProjectID(this);"
            Runat="Server" />
          <asp:Label
          ...
          <AJX:AutoCompleteExtender
            ...
            OnClientItemSelected="script_taCDFinance.ACEProjectID_Selected"
            OnClientPopulating="script_taCDFinance.ACEProjectID_Populating"
            OnClientPopulated="script_taCDFinance.ACEProjectID_Populated"
...
<%--      <tr>
      ...
      <tr><td colspan="4" style="border-top: solid 1pt LightGrey" ></td></tr>
      <tr id="taCDFinance_1"><td colspan="4" onclick="groupClicked(this);" class="groupHeader" >Approval Status</td></tr>
      <tr>
        <td class="alignright">
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "taCDFinanceGetByID"
  UpdateMethod="UZ_taCDFinanceUpdate"
  DeleteMethod="UZ_taCDFinanceDelete"
