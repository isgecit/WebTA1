<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_taD_Driver.aspx.vb" Inherits="EF_taD_Driver" title="Edit: Category Wise Driver Charges" %>
<asp:Content ID="CPHtaD_Driver" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabeltaD_Driver" runat="server" Text="&nbsp;Edit: Category Wise Driver Charges"></asp:Label>
</div>
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "taD_DriverGetByID"
  UpdateMethod="taD_DriverUpdate"
  DeleteMethod="taD_DriverDelete"
