<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_taBDFinance.aspx.vb" Inherits="EF_taBDFinance" title="Edit: Source of Finance" %>
<asp:Content ID="CPHtaBDFinance" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabeltaBDFinance" runat="server" Text="&nbsp;Edit: Source of Finance"></asp:Label>
</div>
...
<asp:FormView ID="FVtaBDFinance"
  ...
  <EditItemTemplate>
    ...
    <table style="margin:auto;border: solid 1pt lightgrey">
      ...
      <tr>
        ...
        <td>
          <asp:TextBox
            ...
            onblur= "script_taBDFinance.validate_ProjectID(this);"
            Runat="Server" />
          <asp:Label
          ...
          <AJX:AutoCompleteExtender
            ...
            OnClientItemSelected="script_taBDFinance.ACEProjectID_Selected"
            OnClientPopulating="script_taBDFinance.ACEProjectID_Populating"
            OnClientPopulated="script_taBDFinance.ACEProjectID_Populated"
      ...
      <tr><td colspan="4" style="border-top: solid 1pt LightGrey" ></td></tr>
      <tr id="taBDFinance_0"><td colspan="4" onclick="groupClicked(this);" class="groupHeader" >Accounts Section</td></tr>
      <tr>
        <td class="alignright">
      ...
      <tr><td colspan="4" style="border-top: solid 1pt LightGrey" ></td></tr>
      <tr id="taBDFinance_1"><td colspan="4" onclick="groupClicked(this);" class="groupHeader" >Approval Status</td></tr>
      <tr>
        <td class="alignright">
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "taBDFinanceGetByID"
  UpdateMethod="UZ_taBDFinanceUpdate"
  DeleteMethod="UZ_taBDFinanceDelete"
