Partial Class GF_taBillPrjAmounts
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/TA_Main/App_Display/DF_taBillPrjAmounts.aspx"
  Protected Sub Info_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
    Dim oBut As ImageButton = CType(sender, ImageButton)
    Dim aVal() As String = oBut.CommandArgument.ToString.Split(",".ToCharArray)
    Dim RedirectUrl As String = _InfoUrl  & "?TABillNo=" & aVal(0) & "&ProjectID=" & aVal(1)
  ...
  Protected Sub GVtaBillPrjAmounts_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVtaBillPrjAmounts.Init
    DataClassName = "GtaBillPrjAmounts"
    SetGridView = GVtaBillPrjAmounts
  End Sub
  ...
  Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    Dim validateScriptTABillNo As String = "<script type=""text/javascript"">" & _
      ...
      "    validated_FK_TA_BillPrjAmounts_TABillNo_main = true;" & _
      "    validate_FK_TA_BillPrjAmounts_TABillNo(o);" & _
      "  }" & _
      "</script>"
    ...
    End If
    Dim validateScriptFK_TA_BillPrjAmounts_TABillNo As String = "<script type=""text/javascript"">" & _
      "  function validate_FK_TA_BillPrjAmounts_TABillNo(o) {" & _
      "    var value = o.id;" & _
      "    var TABillNo = $get('" & F_TABillNo.ClientID & "');" & _
      "    try{" & _
      "    if(TABillNo.value==''){" & _
      "      if(validated_FK_TA_BillPrjAmounts_TABillNo.main){" & _
      ...
      "    PageMethods.validate_FK_TA_BillPrjAmounts_TABillNo(value, validated_FK_TA_BillPrjAmounts_TABillNo);" & _
      "  }" & _
      "  validated_FK_TA_BillPrjAmounts_TABillNo_main = false;" & _
      "  function validated_FK_TA_BillPrjAmounts_TABillNo(result) {" & _
      ...
      "  }" & _
      "</script>"
    If Not Page.ClientScript.IsClientScriptBlockRegistered("validateFK_TA_BillPrjAmounts_TABillNo") Then
      Page.ClientScript.RegisterClientScriptBlock(GetType(System.String), "validateFK_TA_BillPrjAmounts_TABillNo", validateScriptFK_TA_BillPrjAmounts_TABillNo)
    End If
  End Sub
  <System.Web.Services.WebMethod()> _
  Public Shared Function validate_FK_TA_BillPrjAmounts_TABillNo(ByVal value As String) As String
