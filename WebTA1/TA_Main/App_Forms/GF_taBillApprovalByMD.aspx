<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_taBillApprovalByMD.aspx.vb" Inherits="GF_taBillApprovalByMD" title="Maintain List: Approval By MD" %>
<asp:Content ID="CPHtaBillApprovalByMD" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabeltaBillApprovalByMD" runat="server" Text="&nbsp;List: Approval By MD"></asp:Label>
</div>
<div class="pagedata">
<asp:UpdatePanel ID="UPNLtaBillApprovalByMD" runat="server">
  <ContentTemplate>
    <table width="100%"><tr><td class="sis_formview"> 
    <LGM:ToolBar0 
      ID = "TBLtaBillApprovalByMD"
      ToolType = "lgNMGrid"
      EditUrl = "~/TA_Main/App_Edit/EF_taBillApprovalByMD.aspx"
      EnableAdd = "False"
      ValidationGroup = "taBillApprovalByMD"
      runat = "server" />
    <asp:UpdateProgress ID="UPGStaBillApprovalByMD" runat="server" AssociatedUpdatePanelID="UPNLtaBillApprovalByMD" DisplayAfter="100">
      <ProgressTemplate>
      ...
      <tr>
        ...
        <td>
          <asp:DropDownList
            ...
            AutoPostBack="true"
            Runat="Server" >
            <asp:ListItem Selected="True" Value="8" Text="Under Sanction"></asp:ListItem>
            <asp:ListItem Value="0" Text="Sanctioned By Me"></asp:ListItem>
          </asp:DropDownList>
        </td>
      </tr>
    </table>
    ...
    <script type="text/javascript">
      ...
      function print_report(o) {
        pcnt = pcnt + 1;
        var nam = 'wTask' + pcnt;
        var url = self.location.href.replace('App_Forms/GF_taBillApprovalByMD.aspx', 'App_Print/RP_taBH.aspx');
    ...
    <script type="text/javascript"> 
   var script_SARemarks = {
    temp: function() {
    }
    }
    </script>

    <asp:GridView ID="GVtaBillApprovalByMD" SkinID="gv_silver" runat="server" DataSourceID="ODStaBillApprovalByMD" DataKeyNames="TABillNo">
      <Columns>
        ...
        <asp:TemplateField HeaderText="Remarks By MD" SortExpression="SARemarks">
          <ItemTemplate>
          <asp:TextBox ID="F_SARemarks"
            ...
            ToolTip="Enter value for Remarks By MD."
            MaxLength="250"
            runat="server" />
    ...
    <asp:ObjectDataSource 
      ID = "ODStaBillApprovalByMD"
      runat = "server"
      DataObjectTypeName = "SIS.TA.taBillApprovalByMD"
      OldValuesParameterFormatString = "original_{0}"
      SelectMethod = "UZ_taBillApprovalByMDSelectList"
      TypeName = "SIS.TA.taBillApprovalByMD"
      SelectCountMethod = "taBillApprovalByMDSelectCount"
      ...
      <SelectParameters >
        ...
        <asp:ControlParameter ControlID="F_BillStatusID" PropertyName="SelectedValue" Name="BillStatusID" Type="Int32" Size="10" DefaultValue="8" />
  ...
  <Triggers>
    <asp:AsyncPostBackTrigger ControlID="GVtaBillApprovalByMD" EventName="PageIndexChanged" />
