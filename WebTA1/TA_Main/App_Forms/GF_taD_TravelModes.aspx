<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_taD_TravelModes.aspx.vb" Inherits="GF_taD_TravelModes" title="Maintain List: Category Wise Travel Modes" %>
<asp:Content ID="CPHtaD_TravelModes" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabeltaD_TravelModes" runat="server" Text="&nbsp;List: Category Wise Travel Modes"></asp:Label>
</div>
<div class="pagedata">
<asp:UpdatePanel ID="UPNLtaD_TravelModes" runat="server">
  <ContentTemplate>
    <table width="100%"><tr><td class="sis_formview"> 
    <LGM:ToolBar0 
      ID = "TBLtaD_TravelModes"
      ToolType = "lgNMGrid"
      EditUrl = "~/TA_Main/App_Edit/EF_taD_TravelModes.aspx"
      AddUrl = "~/TA_Main/App_Create/AF_taD_TravelModes.aspx"
      ValidationGroup = "taD_TravelModes"
      runat = "server" />
    <asp:UpdateProgress ID="UPGStaD_TravelModes" runat="server" AssociatedUpdatePanelID="UPNLtaD_TravelModes" DisplayAfter="100">
      <ProgressTemplate>
    ...
    <asp:GridView ID="GVtaD_TravelModes" SkinID="gv_silver" runat="server" DataSourceID="ODStaD_TravelModes" DataKeyNames="SerialNo">
      <Columns>
    ...
    <asp:ObjectDataSource 
      ID = "ODStaD_TravelModes"
      runat = "server"
      DataObjectTypeName = "SIS.TA.taD_TravelModes"
      OldValuesParameterFormatString = "original_{0}"
      SelectMethod = "taD_TravelModesSelectList"
      TypeName = "SIS.TA.taD_TravelModes"
      SelectCountMethod = "taD_TravelModesSelectCount"
  ...
  <Triggers>
    <asp:AsyncPostBackTrigger ControlID="GVtaD_TravelModes" EventName="PageIndexChanged" />
