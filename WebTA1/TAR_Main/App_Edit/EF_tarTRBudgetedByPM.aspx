<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_tarTRBudgetedByPM.aspx.vb" Inherits="EF_tarTRBudgetedByPM" title="Edit: Budget Verification By PM" %>
<asp:Content ID="CPHtarTRBudgetedByPM" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabeltarTRBudgetedByPM" runat="server" Text="&nbsp;Edit: Budget Verification By PM"></asp:Label>
</div>
...
<ContentTemplate>
  <LGM:ToolBar0 
    ...
    EnableDelete = "False"
    EnablePrint = "True"
    PrintUrl = "../App_Print/RP_tarTRBudgetedByPM.aspx?pk="
...
<asp:FormView ID="FVtarTRBudgetedByPM"
  runat = "server"
  DataKeyNames = "RequestID"
  DataSourceID = "ODStarTRBudgetedByPM"
  ...
  <EditItemTemplate>
    ...
    <table style="margin:auto;border: solid 1pt lightgrey">
      ...
      <tr>
        <td class="alignright">
          <asp:Label ID="L_ProjectManagerRemarks" runat="server" Text="Remarks :" /><span style="color:red">*</span>
        </td>
        <td>
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "tarTRBudgetedByPMGetByID"
  UpdateMethod="UZ_tarTRBudgetedByPMUpdate"
