<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_tarTRApproval.aspx.vb" Inherits="EF_tarTRApproval" title="Edit: Travel Request Approval" %>
<asp:Content ID="CPHtarTRApproval" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabeltarTRApproval" runat="server" Text="&nbsp;Edit: Travel Request Approval"></asp:Label>
</div>
...
<ContentTemplate>
  <LGM:ToolBar0 
    ...
    EnableDelete = "False"
    EnablePrint = "True"
    PrintUrl = "../App_Print/RP_tarTRApproval.aspx?pk="
...
<asp:FormView ID="FVtarTRApproval"
  runat = "server"
  DataKeyNames = "RequestID"
  DataSourceID = "ODStarTRApproval"
  ...
  <EditItemTemplate>
    ...
    <table style="margin:auto;border: solid 1pt lightgrey">
      ...
      <tr>
        <td class="alignright">
          <asp:Label ID="L_ApproverRemarks" runat="server" Text="Remarks :" /><span style="color:red">*</span>
        </td>
        <td>
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "tarTRApprovalGetByID"
  UpdateMethod="UZ_tarTRApprovalUpdate"
