<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="False" CodeFile="GF_tarTRApproval.aspx.vb" Inherits="GF_tarTRApproval" title="Maintain List: Travel Request Approval" %>
<asp:Content ID="CPHtarTRApproval" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabeltarTRApproval" runat="server" Text="&nbsp;List: Travel Request Approval"></asp:Label>
</div>
<div class="pagedata">
<asp:UpdatePanel ID="UPNLtarTRApproval" runat="server">
  <ContentTemplate>
    <table width="100%"><tr><td class="sis_formview"> 
    <LGM:ToolBar0 
      ID = "TBLtarTRApproval"
      ToolType = "lgNMGrid"
      EditUrl = "~/TAR_Main/App_Edit/EF_tarTRApproval.aspx"
      EnableAdd = "False"
      ValidationGroup = "tarTRApproval"
      runat = "server" />
    <asp:UpdateProgress ID="UPGStarTRApproval" runat="server" AssociatedUpdatePanelID="UPNLtarTRApproval" DisplayAfter="100">
      <ProgressTemplate>
   ...
   var script_ApproverRemarks = {
    ...
    <asp:GridView ID="GVtarTRApproval" SkinID="gv_silver" runat="server" DataSourceID="ODStarTRApproval" DataKeyNames="RequestID">
      <Columns>
        ...
        <asp:TemplateField HeaderText="Remarks" SortExpression="ApproverRemarks">
          <ItemTemplate>
    ...
    <asp:ObjectDataSource 
      ID = "ODStarTRApproval"
      runat = "server"
      DataObjectTypeName = "SIS.TAR.tarTRApproval"
      OldValuesParameterFormatString = "original_{0}"
      SelectMethod = "UZ_tarTRApprovalSelectList"
      TypeName = "SIS.TAR.tarTRApproval"
      SelectCountMethod = "tarTRApprovalSelectCount"
  ...
  <Triggers>
    <asp:AsyncPostBackTrigger ControlID="GVtarTRApproval" EventName="PageIndexChanged" />
