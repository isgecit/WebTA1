<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="False" CodeFile="GF_tarTRSanction.aspx.vb" Inherits="GF_tarTRSanction" title="Maintain List: Travel Request Sanction" %>
<asp:Content ID="CPHtarTRSanction" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabeltarTRSanction" runat="server" Text="&nbsp;List: Travel Request Sanction"></asp:Label>
</div>
<div class="pagedata">
<asp:UpdatePanel ID="UPNLtarTRSanction" runat="server">
  <ContentTemplate>
    ...
    <LGM:ToolBar0 
      ID = "TBLtarTRSanction"
      ToolType = "lgNMGrid"
      EditUrl = "~/TAR_Main/App_Edit/EF_tarTRSanction.aspx"
      EnableAdd = "False"
      ValidationGroup = "tarTRSanction"
      runat = "server" />
    <asp:UpdateProgress ID="UPGStarTRSanction" runat="server" AssociatedUpdatePanelID="UPNLtarTRSanction" DisplayAfter="100">
      <ProgressTemplate>
    ...
    <script type="text/javascript"> 
   var script_BHRemarks = {
    temp: function() {
    }
    }
    </script>

    <asp:GridView ID="GVtarTRSanction" SkinID="gv_silver" runat="server" DataSourceID="ODStarTRSanction" DataKeyNames="RequestID">
      <Columns>
        ...
        <asp:TemplateField HeaderText="Remarks" SortExpression="BHRemarks">
          <ItemTemplate>
    ...
    <asp:ObjectDataSource 
      ...
      SelectMethod = "UZ_tarTRSanctionSelectList"
      TypeName = "SIS.TAR.tarTRSanction"
      SelectCountMethod = "tarTRSanctionSelectCount"
  ...
  <Triggers>
    <asp:AsyncPostBackTrigger ControlID="GVtarTRSanction" EventName="PageIndexChanged" />
