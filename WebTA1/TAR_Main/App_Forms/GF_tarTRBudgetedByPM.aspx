<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="False" CodeFile="GF_tarTRBudgetedByPM.aspx.vb" Inherits="GF_tarTRBudgetedByPM" title="Maintain List: Budget Verification By PM" %>
<asp:Content ID="CPHtarTRBudgetedByPM" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabeltarTRBudgetedByPM" runat="server" Text="&nbsp;List: Budget Verification By PM"></asp:Label>
</div>
<div class="pagedata">
<asp:UpdatePanel ID="UPNLtarTRBudgetedByPM" runat="server">
  <ContentTemplate>
    <table width="100%"><tr><td class="sis_formview"> 
    <LGM:ToolBar0 
      ID = "TBLtarTRBudgetedByPM"
      ToolType = "lgNMGrid"
      EditUrl = "~/TAR_Main/App_Edit/EF_tarTRBudgetedByPM.aspx"
      EnableAdd = "False"
      ValidationGroup = "tarTRBudgetedByPM"
      runat = "server" />
    <asp:UpdateProgress ID="UPGStarTRBudgetedByPM" runat="server" AssociatedUpdatePanelID="UPNLtarTRBudgetedByPM" DisplayAfter="100">
      <ProgressTemplate>
    ...
    <script type="text/javascript"> 
   var script_ProjectManagerRemarks = {
    temp: function() {
    }
    }
    </script>

    <asp:GridView ID="GVtarTRBudgetedByPM" SkinID="gv_silver" runat="server" DataSourceID="ODStarTRBudgetedByPM" DataKeyNames="RequestID">
      <Columns>
        ...
        <asp:TemplateField HeaderText="Submitted By" SortExpression="aspnet_users2_UserFullName">
          <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Remarks" SortExpression="ProjectManagerRemarks">
          <ItemTemplate>
          ...
          <asp:RequiredFieldValidator 
            ID = "RFVProjectManagerRemarks"
            runat = "server"
            ControlToValidate = "F_ProjectManagerRemarks"
        ...
        <asp:TemplateField HeaderText="Check Budget">
          <ItemTemplate>
            <asp:ImageButton ID="cmdBudget" ValidationGroup='<%# "Budget" & Container.DataItemIndex %>' CausesValidation="true" runat="server" Visible='<%# EVal("BudgetWFVisible") %>' Enabled='<%# EVal("BudgetWFEnable") %>' AlternateText='<%# EVal("PrimaryKey") %>' ToolTip="Check Project Budget" SkinID="info" CommandName="BudgetWF" CommandArgument='<%# Container.DataItemIndex %>' />
          </ItemTemplate>
          <ItemStyle CssClass="alignCenter" />
          <HeaderStyle HorizontalAlign="Center" Width="30px" />
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Budget OK">
          <ItemTemplate>
            <asp:ImageButton ID="cmdApproveWF" ValidationGroup='<%# "Approve" & Container.DataItemIndex %>' CausesValidation="true" runat="server" Visible='<%# EVal("ApproveWFVisible") %>' Enabled='<%# EVal("ApproveWFEnable") %>' AlternateText='<%# EVal("PrimaryKey") %>' ToolTip="Approve" SkinID="approve" OnClientClick='<%# "return Page_ClientValidate(""Approve" & Container.DataItemIndex & """) && confirm(""Budget Entered ?"");" %>' CommandName="ApproveWF" CommandArgument='<%# Container.DataItemIndex %>' />
          </ItemTemplate>
          <ItemStyle CssClass="alignCenter" />
          <HeaderStyle HorizontalAlign="Center" Width="30px" />
        </asp:TemplateField>
    ...
    <asp:ObjectDataSource 
      ID = "ODStarTRBudgetedByPM"
      runat = "server"
      DataObjectTypeName = "SIS.TAR.tarTRBudgetedByPM"
      OldValuesParameterFormatString = "original_{0}"
      SelectMethod = "UZ_tarTRBudgetedByPMSelectList"
      TypeName = "SIS.TAR.tarTRBudgetedByPM"
      SelectCountMethod = "tarTRBudgetedByPMSelectCount"
  ...
  <Triggers>
    <asp:AsyncPostBackTrigger ControlID="GVtarTRBudgetedByPM" EventName="PageIndexChanged" />
