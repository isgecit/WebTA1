  ...
  Partial Public Class taD_Driver
    ...
    Public Shared Function SetDefaultValues(ByVal sender As System.Web.UI.WebControls.FormView, ByVal e As System.EventArgs) As System.Web.UI.WebControls.FormView
      With sender
        ...
        'CType(.FindControl("F_DriverAmount"), TextBox).Text = ""
      ...
      Return sender
    End Function
    Public Shared Function GetByCategoryID(ByVal CategoryID As Int32, ByVal ForStartDate As DateTime) As SIS.TA.taD_Driver
      Dim Results As SIS.TA.taD_Driver = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spta_LG_D_DriverSelectByCategoryID"
