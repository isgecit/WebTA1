...
Namespace SIS.TA
  Partial Public Class taBillApprovalByBH
    ...
    Public ReadOnly Property RejectWFEnable() As Boolean
      ...
      End Get
    End Property
    Public Shared Function ApproveWF(ByVal TABillNo As Int32, ByVal CCRemarks As String) As SIS.TA.taBillApprovalByBH
      Dim Results As SIS.TA.taBillApprovalByBH = taBillApprovalByBHGetByID(TABillNo)
      With Results
        .ApprovedByCC = HttpContext.Current.Session("LoginID")
        .ApprovedByCCOn = Now
        .CCRemarks = CCRemarks
      ...
      Try
        SendEMail(Results)
        SendLinkEMail(Results)
      Catch ex As Exception
      End Try
      Return Results
    End Function
    Public Shared Function RejectWF(ByVal TABillNo As Int32, ByVal CCRemarks As String) As SIS.TA.taBillApprovalByBH
      Dim Results As SIS.TA.taBillApprovalByBH = taBillApprovalByBHGetByID(TABillNo)
      With Results
        .ApprovedByCC = HttpContext.Current.Session("LoginID")
        .ApprovedByCCOn = Now
        .CCRemarks = CCRemarks
        .BillStatusID = TAStates.ReturnedByApprover
      End With
      Results = SIS.TA.taBH.UpdateData(Results)
      Return Results
    End Function
    Public Shared Function UZ_taBillApprovalByBHSelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal TABillNo As Int32, ByVal TravelTypeID As Int32, ByVal DestinationCity As String, ByVal ProjectID As String, ByVal EmployeeID As String, ByVal BillStatusID As Int32) As List(Of SIS.TA.taBillApprovalByBH)
      ...
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          If SearchState Then
            Cmd.CommandText = "spta_LG_BillApprovalByBHSelectListSearch"
            SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@KeyWord", SqlDbType.NVarChar, 250, SearchText)
          Else
            Cmd.CommandText = "spta_LG_BillApprovalByBHSelectListFilteres"
      ...
      Return Results
    End Function
    Public Shared Function UZ_taBillApprovalByBHUpdate(ByVal Record As SIS.TA.taBillApprovalByBH) As SIS.TA.taBillApprovalByBH
      Dim _Result As SIS.TA.taBillApprovalByBH = taBillApprovalByBHUpdate(Record)
      Return _Result
    End Function
