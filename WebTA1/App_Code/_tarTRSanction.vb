...
Namespace SIS.TAR
  ...
  Partial Public Class tarTRSanction
    ...
    Public Shared Function tarTRSanctionGetNewRecord() As SIS.TAR.tarTRSanction
      Return New SIS.TAR.tarTRSanction()
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function tarTRSanctionSelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal ProjectID As String, ByVal CreatedBy As String) As List(Of SIS.TAR.tarTRSanction)
      ...
      Return Results
    End Function
    Public Shared Function tarTRSanctionSelectCount(ByVal SearchState As Boolean, ByVal SearchText As String, ByVal ProjectID As String, ByVal CreatedBy As String) As Integer
      Return RecordCount
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function tarTRSanctionGetByID(ByVal RequestID As Int32) As SIS.TAR.tarTRSanction
      Dim Results As SIS.TAR.tarTRSanction = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          ...
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          If Reader.Read() Then
            Results = New SIS.TAR.tarTRSanction(Reader)
          End If
          Reader.Close()
        End Using
      End Using
    ...
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function tarTRSanctionGetByID(ByVal RequestID As Int32, ByVal Filter_ProjectID As String, ByVal Filter_CreatedBy As String) As SIS.TAR.tarTRSanction
      Dim Results As SIS.TAR.tarTRSanction = SIS.TAR.tarTRSanction.tarTRSanctionGetByID(RequestID)
      Return Results
    End Function
    <DataObjectMethod(DataObjectMethodType.Update, True)> _
    Public Shared Function tarTRSanctionUpdate(ByVal Record As SIS.TAR.tarTRSanction) As SIS.TAR.tarTRSanction
      Dim _Rec As SIS.TAR.tarTRSanction = SIS.TAR.tarTRSanction.tarTRSanctionGetByID(Record.RequestID)
      With _Rec
      ...
      End With
      Return SIS.TAR.tarTRSanction.UpdateData(_Rec)
    End Function
