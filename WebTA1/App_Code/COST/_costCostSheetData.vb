...
Namespace SIS.COST
  ...
  Partial Public Class costCostSheetData
    ...
    Private _FK_COST_CostSheetData_CostSheet As SIS.COST.costCostSheet = Nothing
    Private _FK_COST_CostSheetData_GLCode As SIS.COST.costERPGLCodes = Nothing
    Private _FK_COST_CostSheetData_FinYear As SIS.COST.costFinYear = Nothing
    Private _FK_COST_CostSheetData_ProjectGroupID As SIS.COST.costProjectGroups = Nothing
    Private _FK_COST_CostSheetData_Quarter As SIS.COST.costQuarters = Nothing
    Private _FK_COST_CostSheetData_ProjectID As SIS.COST.costProjects = Nothing
    ...
    Public Shared Property RecordCount() As Integer
      ...
      End Set
    End Property
    Public Class PKcostCostSheetData
      Private _ProjectGroupID As Int32 = 0
      Private _FinYear As Int32 = 0
      Private _Quarter As Int32 = 0
      Private _Revision As Int32 = 0
      ...
      End Property
    End Class
    Public ReadOnly Property FK_COST_CostSheetData_CostSheet() As SIS.COST.costCostSheet
      Get
        If _FK_COST_CostSheetData_CostSheet Is Nothing Then
          _FK_COST_CostSheetData_CostSheet = SIS.COST.costCostSheet.costCostSheetGetByID(_ProjectGroupID, _FinYear, _Quarter, _Revision)
        End If
        Return _FK_COST_CostSheetData_CostSheet
      End Get
    End Property
    Public ReadOnly Property FK_COST_CostSheetData_GLCode() As SIS.COST.costERPGLCodes
      Get
        If _FK_COST_CostSheetData_GLCode Is Nothing Then
          _FK_COST_CostSheetData_GLCode = SIS.COST.costERPGLCodes.costERPGLCodesGetByID(_GLCode)
        End If
        Return _FK_COST_CostSheetData_GLCode
      End Get
    End Property
    Public ReadOnly Property FK_COST_CostSheetData_FinYear() As SIS.COST.costFinYear
      Get
        If _FK_COST_CostSheetData_FinYear Is Nothing Then
          _FK_COST_CostSheetData_FinYear = SIS.COST.costFinYear.costFinYearGetByID(_FinYear)
        End If
        Return _FK_COST_CostSheetData_FinYear
      End Get
    End Property
    Public ReadOnly Property FK_COST_CostSheetData_ProjectGroupID() As SIS.COST.costProjectGroups
      Get
        If _FK_COST_CostSheetData_ProjectGroupID Is Nothing Then
          _FK_COST_CostSheetData_ProjectGroupID = SIS.COST.costProjectGroups.costProjectGroupsGetByID(_ProjectGroupID)
        End If
        Return _FK_COST_CostSheetData_ProjectGroupID
      End Get
    End Property
    Public ReadOnly Property FK_COST_CostSheetData_Quarter() As SIS.COST.costQuarters
      Get
        If _FK_COST_CostSheetData_Quarter Is Nothing Then
          _FK_COST_CostSheetData_Quarter = SIS.COST.costQuarters.costQuartersGetByID(_Quarter)
        End If
        Return _FK_COST_CostSheetData_Quarter
      End Get
    End Property
    Public ReadOnly Property FK_COST_CostSheetData_ProjectID() As SIS.COST.costProjects
      Get
        If _FK_COST_CostSheetData_ProjectID Is Nothing Then
          _FK_COST_CostSheetData_ProjectID = SIS.COST.costProjects.costProjectsGetByID(_ProjectID)
        End If
        Return _FK_COST_CostSheetData_ProjectID
      End Get
    End Property
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function costCostSheetDataGetNewRecord() As SIS.COST.costCostSheetData
      Return New SIS.COST.costCostSheetData()
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function costCostSheetDataGetByID(ByVal ProjectGroupID As Int32, ByVal FinYear As Int32, ByVal Quarter As Int32, ByVal Revision As Int32, ByVal ProjectID As String, ByVal GLCode As String, ByVal AdjustmentSerialNo As Int32, ByVal AdjustmentCredit As Boolean) As SIS.COST.costCostSheetData
      Dim Results As SIS.COST.costCostSheetData = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spcostCostSheetDataSelectByID"
          ...
          If Reader.Read() Then
            Results = New SIS.COST.costCostSheetData(Reader)
          End If
          Reader.Close()
        End Using
      End Using
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByAdjustmentSerialNo(ByVal AdjustmentSerialNo As Int32, ByVal OrderBy as String) As List(Of SIS.COST.costCostSheetData)
      Dim Results As List(Of SIS.COST.costCostSheetData) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spcostCostSheetDataSelectByAdjustmentSerialNo"
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@AdjustmentSerialNo",SqlDbType.Int,AdjustmentSerialNo.ToString.Length, AdjustmentSerialNo)
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@LoginID", SqlDbType.NvarChar, 9, HttpContext.Current.Session("LoginID"))
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function costCostSheetDataSelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal Quarter As Int32, ByVal FinYear As Int32, ByVal ProjectGroupID As Int32, ByVal Revision As Int32) As List(Of SIS.COST.costCostSheetData)
      Dim Results As List(Of SIS.COST.costCostSheetData) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
      ...
      Return Results
    End Function
    Public Shared Function costCostSheetDataSelectCount(ByVal SearchState As Boolean, ByVal SearchText As String, ByVal Quarter As Int32, ByVal FinYear As Int32, ByVal ProjectGroupID As Int32, ByVal Revision As Int32) As Integer
      Return _RecordCount
    End Function
      'Select By ID One Record Filtered Overloaded GetByID
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function costCostSheetDataGetByID(ByVal ProjectGroupID As Int32, ByVal FinYear As Int32, ByVal Quarter As Int32, ByVal Revision As Int32, ByVal ProjectID As String, ByVal GLCode As String, ByVal AdjustmentSerialNo As Int32, ByVal AdjustmentCredit As Boolean, ByVal Filter_Quarter As Int32, ByVal Filter_FinYear As Int32, ByVal Filter_ProjectGroupID As Int32, ByVal Filter_Revision As Int32) As SIS.COST.costCostSheetData
      Return costCostSheetDataGetByID(ProjectGroupID, FinYear, Quarter, Revision, ProjectID, GLCode, AdjustmentSerialNo, AdjustmentCredit)
    End Function
    <DataObjectMethod(DataObjectMethodType.Insert, True)> _
    Public Shared Function costCostSheetDataInsert(ByVal Record As SIS.COST.costCostSheetData) As SIS.COST.costCostSheetData
      Dim _Rec As SIS.COST.costCostSheetData = SIS.COST.costCostSheetData.costCostSheetDataGetNewRecord()
      With _Rec
      ...
      End With
      Return SIS.COST.costCostSheetData.InsertData(_Rec)
    End Function
    Public Shared Function InsertData(ByVal Record As SIS.COST.costCostSheetData) As SIS.COST.costCostSheetData
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spcostCostSheetDataInsert"
    ...
    Public Shared Function costCostSheetDataUpdate(ByVal Record As SIS.COST.costCostSheetData) As SIS.COST.costCostSheetData
      Dim _Rec As SIS.COST.costCostSheetData = SIS.COST.costCostSheetData.costCostSheetDataGetByID(Record.ProjectGroupID, Record.FinYear, Record.Quarter, Record.Revision, Record.ProjectID, Record.GLCode, Record.AdjustmentSerialNo, Record.AdjustmentCredit)
      With _Rec
        .CrAmount = Record.CrAmount
        .DrAmount = Record.DrAmount
        .Amount = Record.Amount
        .AdjustmentEntry = Record.AdjustmentEntry
      End With
      Return SIS.COST.costCostSheetData.UpdateData(_Rec)
    End Function
    Public Shared Function UpdateData(ByVal Record As SIS.COST.costCostSheetData) As SIS.COST.costCostSheetData
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spcostCostSheetDataUpdate"
    ...
    Public Shared Function costCostSheetDataDelete(ByVal Record As SIS.COST.costCostSheetData) As Int32
      Dim _Result as Integer = 0
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spcostCostSheetDataDelete"
