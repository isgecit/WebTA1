...
Namespace SIS.TAR
  ...
  Partial Public Class tarTRBudgetedByPM
    ...
    Public Shared Function tarTRBudgetedByPMGetNewRecord() As SIS.TAR.tarTRBudgetedByPM
      Return New SIS.TAR.tarTRBudgetedByPM()
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function tarTRBudgetedByPMSelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal ProjectID As String, ByVal CreatedBy As String) As List(Of SIS.TAR.tarTRBudgetedByPM)
      ...
      Return Results
    End Function
    Public Shared Function tarTRBudgetedByPMSelectCount(ByVal SearchState As Boolean, ByVal SearchText As String, ByVal ProjectID As String, ByVal CreatedBy As String) As Integer
      Return RecordCount
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function tarTRBudgetedByPMGetByID(ByVal RequestID As Int32) As SIS.TAR.tarTRBudgetedByPM
      Dim Results As SIS.TAR.tarTRBudgetedByPM = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          ...
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          If Reader.Read() Then
            Results = New SIS.TAR.tarTRBudgetedByPM(Reader)
          End If
          Reader.Close()
        End Using
      End Using
    ...
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function tarTRBudgetedByPMGetByID(ByVal RequestID As Int32, ByVal Filter_ProjectID As String, ByVal Filter_CreatedBy As String) As SIS.TAR.tarTRBudgetedByPM
      Dim Results As SIS.TAR.tarTRBudgetedByPM = SIS.TAR.tarTRBudgetedByPM.tarTRBudgetedByPMGetByID(RequestID)
      Return Results
    End Function
    <DataObjectMethod(DataObjectMethodType.Update, True)> _
    Public Shared Function tarTRBudgetedByPMUpdate(ByVal Record As SIS.TAR.tarTRBudgetedByPM) As SIS.TAR.tarTRBudgetedByPM
      Dim _Rec As SIS.TAR.tarTRBudgetedByPM = SIS.TAR.tarTRBudgetedByPM.tarTRBudgetedByPMGetByID(Record.RequestID)
      With _Rec
      ...
      End With
      Return SIS.TAR.tarTRBudgetedByPM.UpdateData(_Rec)
    End Function
