...
Partial Class LC_PrkBalanceSep
  ...
  Public Function LoadData() As Double
    ...
    Dim tmpDt As String = "01/10/2017"
    Select Case _PerkID
      Case prkPerk.MedicalBenifit, prkPerk.CarInsurance, prkPerk.Mediclaim
        tmpDt = "01/04/2018"
    End Select

    Dim oEnts As List(Of SIS.NPRK.nprkEntitlements) = SIS.NPRK.nprkEntitlements.SelectListSep(_EmployeeID, _PerkID, Convert.ToDateTime(tmpDt))
    _EntitlementsCount = oEnts.Count
    Dim oPmts As List(Of SIS.NPRK.nprkLedger) = SIS.NPRK.nprkLedger.GetByEmployeeIDPerkIDSep(_EmployeeID, _PerkID, Convert.ToDateTime(tmpDt))
