<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="False" CodeFile="GF_nprkCashPayment.aspx.vb" Inherits="GF_nprkCashPayment" title="Maintain List: Cash Payment" %>
<asp:Content ID="CPHnprkCashPayment" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabelnprkCashPayment" runat="server" Text="&nbsp;List: Cash Payment"></asp:Label>
...
<asp:UpdatePanel ID="UPNLnprkCashPayment" runat="server">
  <ContentTemplate>
    ...
    <LGM:ToolBar0 
      ...
      ToolType = "lgNMGrid"
      EditUrl = "~/NPRK_Main/App_Edit/EF_nprkCashPayment.aspx"
      EnableAdd = "False"
      ValidationGroup = "nprkCashPayment"
      runat = "server" />
    <asp:UpdateProgress ID="UPGSnprkCashPayment" runat="server" AssociatedUpdatePanelID="UPNLnprkCashPayment" DisplayAfter="100">
      <ProgressTemplate>
   ...
   var script_UpdatedInLedger = {
    ...
    <asp:GridView ID="GVnprkCashPayment" SkinID="gv_silver" runat="server" DataSourceID="ODSnprkCashPayment" DataKeyNames="ClaimID,ApplicationID">
      <Columns>
        ...
        <asp:TemplateField HeaderText="Paid At">
          <ItemTemplate>
          <asp:DropDownList
            ID="F_PaidAt"
    ...
    <asp:ObjectDataSource 
      ...
      SelectMethod = "UZ_nprkCashPaymentSelectList"
      TypeName = "SIS.NPRK.nprkCashPayment"
      SelectCountMethod = "nprkCashPaymentSelectCount"
  ...
  <Triggers>
    <asp:AsyncPostBackTrigger ControlID="GVnprkCashPayment" EventName="PageIndexChanged" />
