Partial Class GF_nprkEmployeesMonthlyBasic
  ...
  Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    Dim validateScriptEmployeeID As String = "<script type=""text/javascript"">" & _
      ...
      "    validated_FK_PRK_EmployeesMonthlyBasic_PRK_Employees_main = true;" & _
      "    validate_FK_PRK_EmployeesMonthlyBasic_PRK_Employees(o);" & _
      "  }" & _
      "</script>"
    ...
    End If
    Dim validateScriptFK_PRK_EmployeesMonthlyBasic_PRK_Employees As String = "<script type=""text/javascript"">" & _
      "  function validate_FK_PRK_EmployeesMonthlyBasic_PRK_Employees(o) {" & _
      "    var value = o.id;" & _
      "    var EmployeeID = $get('" & F_EmployeeID.ClientID & "');" & _
      "    try{" & _
      "    if(EmployeeID.value==''){" & _
      "      if(validated_FK_PRK_EmployeesMonthlyBasic_PRK_Employees.main){" & _
      ...
      "    PageMethods.validate_FK_PRK_EmployeesMonthlyBasic_PRK_Employees(value, validated_FK_PRK_EmployeesMonthlyBasic_PRK_Employees);" & _
      "  }" & _
      "  validated_FK_PRK_EmployeesMonthlyBasic_PRK_Employees_main = false;" & _
      "  function validated_FK_PRK_EmployeesMonthlyBasic_PRK_Employees(result) {" & _
