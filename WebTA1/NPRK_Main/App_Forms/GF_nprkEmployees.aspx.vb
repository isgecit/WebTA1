Partial Class GF_nprkEmployees
  Inherits SIS.SYS.GridBase
  Protected Sub GVnprkEmployees_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GVnprkEmployees.RowCommand
    If e.CommandName.ToLower = "lgedit".ToLower Then
      Try
        Dim EmployeeID As Int32 = GVnprkEmployees.DataKeys(e.CommandArgument).Values("EmployeeID")
        Dim RedirectUrl As String = TBLnprkEmployees.EditUrl & "?EmployeeID=" & EmployeeID
        Response.Redirect(RedirectUrl)
      Catch ex As Exception
      End Try
    End If
  End Sub
  Protected Sub GVnprkEmployees_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVnprkEmployees.Init
    DataClassName = "GnprkEmployees"
    SetGridView = GVnprkEmployees
  End Sub
