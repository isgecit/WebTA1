<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_nprkChequePayment.aspx.vb" Inherits="EF_nprkChequePayment" title="Edit: Cheque Payment" %>
<asp:Content ID="CPHnprkChequePayment" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelnprkChequePayment" runat="server" Text="&nbsp;Edit: Cheque Payment"></asp:Label>
</div>
...
<ContentTemplate>
  <LGM:ToolBar0 
    ...
    runat = "server" />
<asp:FormView ID="FVnprkChequePayment"
  runat = "server"
  DataKeyNames = "ClaimID,ApplicationID"
  DataSourceID = "ODSnprkChequePayment"
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "nprkChequePaymentGetByID"
  UpdateMethod="UZ_nprkChequePaymentUpdate"
